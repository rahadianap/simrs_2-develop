...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('dbclient')->create('tb_trx_lab', function (Blueprint $table) {
            ...
            $table->boolean('is_hasil')->default(0);
    ...
    {
        Schema::connection('dbclient')->dropIfExists('tb_trx_lab');
    }
};
