...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('dbclient')->create('tb_linen_detail', function (Blueprint $table) {
            $table->string('linen_detail_id', 100)->primary();
            $table->string('trx_linen_id', 100);
            $table->string('trx_linen_reff', 100)->nullable();
    ...
    {
        Schema::connection('dbclient')->dropIfExists('tb_linen_detail');
    }
};
