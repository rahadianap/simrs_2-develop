...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('dbclient')->create('tb_operasi_detail', function (Blueprint $table) {
            ...
            $table->string('tim_operasi_id', 100)->nullable();
    ...
    {
        Schema::connection('dbclient')->dropIfExists('tb_operasi_detail');
    }
};
