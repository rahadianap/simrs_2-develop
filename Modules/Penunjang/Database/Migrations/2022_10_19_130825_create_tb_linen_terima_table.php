...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('dbclient')->create('tb_linen_terima', function (Blueprint $table) {
            $table->string('linen_terima_id', 100)->primary();
            ...
            $table->boolean('is_infeksius')->default(0);
    ...
    {
        Schema::connection('dbclient')->dropIfExists('tb_linen_terima');
    }
};
