...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('dbclient')->create('tb_cssd_dist', function (Blueprint $table) {
            $table->string('cssd_dist_id', 100)->primary();
            ...
            $table->string('cssd_terima_id', 100)->nullable();
    ...
    {
        Schema::connection('dbclient')->dropIfExists('tb_cssd_dist');
    }
};
