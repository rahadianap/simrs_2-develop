...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('dbclient')->create('tb_pemeriksaan_detail', function (Blueprint $table) {
    ...
    {
        Schema::connection('dbclient')->dropIfExists('tb_pemeriksaan_detail');
    }
};
