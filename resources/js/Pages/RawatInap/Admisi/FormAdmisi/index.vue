<template>
    <div class="uk-container">
        <header-page title="FORM ADMISI INAP" subTitle="form pendaftaran rawat inap"></header-page>
        <div style="margin:1em 0 0 0;padding:1em;background-color: #fff;">
            <ul class="uk-tab hims-inap-tab uk-hidden" uk-switcher id="switcherFormAdmisi" style="padding:0;margin:0;">
                <li style="padding:0;"><div><a href="#"><h5>Form Registrasi</h5></a></div></li> 
                <li v-if="!isUpdate"><div><a href="#"><h5>Pilih Pasien</h5></a></div></li>
            </ul>
            <ul class="uk-switcher">
                            ...
                            <div class="uk-container uk-container-large">                
                                ...
                                <div class="hims-form-container" style="padding:0 1.5em 2em 1.5em; margin:0;">     
                                    <div class="uk-grid-small hims-form-subpage" uk-grid  style="border:none;">                        
                                        <div class="uk-width-1-4@m" style="padding:0 0.5em 1em 0.5em;">
                                            ...
                                            <template v-if="!isUpdate">
                                                <div class="uk-width-auto" style="margin-left:1em;">
                                            ...
                                            <div v-if="registrasi.pasien.pasien_id == null" class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">                        
                                                <div class="uk-width-1-1">
                                                    <p style="font-style: italic;color:black;">(pasien belum dipilih)</p>
                                                </div>
                                            </div>
                                            <div v-else class="uk-width-1-1@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">       
                                                <div class="uk-width-1-1">
                                    ...
                                    <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                                        <div class="uk-width-1-4@m" style="padding:0 0.5em 1em 0.5em;">
                                            <h5 style="color:indigo;padding:0;margin:0;">PENJAMIN DAN PENANGGUNG</h5>
                                            <p style="font-size:12px;font-style:italic;padding:0;margin:0;">
                                                detail data penjamin (asuransi) dan penanggung.
                                            </p>
                                        </div>
                                        <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                            ...
                                            <div class="uk-width-1-4@m">
                                                ...
                                                <div class="uk-form-controls">
                                                    <select v-model="registrasi.kelas_harga_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;" @change="updateKelasHarga">
                                            ...
                                            <div class="uk-width-1-4@m">
                                                ...
                                                <div class="uk-form-controls">
                                                    <select v-model="registrasi.kelas_penjamin_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;">
                                                        <option v-for="option in kelasHargaLists" v-bind:value="option.kelas_id">{{option.kelas_nama}}</option>
                                                    </select>
                                                </div>
                                            </div>    
                ...
                <li v-if="!isUpdate">
                    <list-pasien ref="listAsalPasienInap" v-on:pasienInapSelected="refreshPasien"></list-pasien>
                </li>
            </ul>
...
import ModalPickerRuang from '@/Pages/RawatInap/Components/ModalPickerRuang';
import ListPasien from '@/Pages/RawatInap/Components/ListPasien';
...
export default {
    ...
    components : { SearchSelect,SearchList,ModalPickerRuang, ListPasien,headerPage },
    data() {
        return {
            isUpdate : false,
            isLoading : false,
    ...
    methods : {
        ...
        modalClosed(){
            this.clearRegistrasi();
            // this.$emit('registrasiInapClosed',true);
            this.$router.push({ name: 'listAdmisi' });
        },
        ...
        addPasien() {
            this.$refs.listAsalPasienInap.addPasien();
        },

        editPasien() {
            this.$refs.listAsalPasienInap.editDataPasien(this.registrasi.pasien);
        },
        ...
        clearRegistrasi() {
            ...
            this.registrasi.kelas_penjamin_id = null;
        ...
        fillRegistrasi(data){
            ...
            this.registrasi.kelas_penjamin_id = data.kelas_penjamin_id;
