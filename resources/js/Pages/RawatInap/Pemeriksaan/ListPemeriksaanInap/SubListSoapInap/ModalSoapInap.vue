                    ...
                    <div class="uk-grid-small hims-form-subpage" uk-grid >
                        ...
                        <div class="uk-width-3-4@s uk-grid-small" uk-grid> 
                            <div class="uk-width-1-2@m">
                                ...
                                <div class="uk-form-controls">
                                    <textarea type="textarea" rows="6" v-model="asesmenData.subjective" class="uk-textarea uk-form-small"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="uk-width-1-2@m">
                                ...
                                <div class="uk-form-controls">
                                    <textarea type="textarea" rows="6" v-model="asesmenData.objective" class="uk-textarea uk-form-small"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="uk-width-1-2@m">
                                ...
                                <div class="uk-form-controls">
                                    <textarea type="textarea" rows="6" v-model="asesmenData.assesment" class="uk-textarea uk-form-small"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="uk-width-1-2@m">
                                ...
                                <div class="uk-form-controls">
                                    <textarea type="textarea" rows="6" v-model="asesmenData.plan" class="uk-textarea uk-form-small"></textarea>
                                </div>
                            </div>
                                ...
                                <div style="padding:0 0 0.2em 0;">
                                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0;">
                                        <thead>
                                            ...
                                            <th class="tb-header-reg" style="text-align:left;color:white;background-color:#cc0202;">ICD</th>
                                            <th class="tb-header-reg" style="text-align:left;color:white;background-color:#cc0202;">Diagnosa</th>
                                            <th class="tb-header-reg" style="width:100px;text-align:left;color:white;background-color:#cc0202;">Kasus Lama</th>
                                            <th class="tb-header-reg" style="width:80px;text-align:center;color:white;background-color:#cc0202;">...</th>
                                        </thead>
                                        <tbody>
                                            <tr>
...
export default {
    name : 'modal-soap-inap',
    props : { 
        modalId : { type:String, required:false, default:'modalAsesmenInap' }, 
    },
    ...
    methods : {
        ...
        ...mapActions('asesmen',['dataAsesmen','updateAsesmen','createAsesmen']),
