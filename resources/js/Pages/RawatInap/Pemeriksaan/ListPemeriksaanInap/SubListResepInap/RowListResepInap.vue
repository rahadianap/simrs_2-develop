            ...
            <td colspan="7" v-if="isExpandedReg" style="background-color:#fff;border-top:0px solid #000;padding:0;margin:0;">
                <div style="padding:0.5em;background-color:white;">
                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0;">
                        <thead>
                            <th colspan="2" class="tb-header-reg-sub" style="font-size:11px;text-align:left;color:black;">Item Resep</th>
                        ...
                        <tbody>
                            <tr v-if="rowData.detail" v-for="dtl in rowData.detail" style="border-bottom:1px solid #ccc;" v-bind:class="dtl.is_aktif != true ? 'inaktif':'' ">        
                                <template v-if = "dtl.item_tipe == 'NON_RACIKAN'">
                                    <td colspan="2" style="padding:1em; font-weight: 500; font-size: 11px; color:black;">
                                ...
                                <template v-else-if = "dtl.item_tipe == 'HEADER_RACIKAN'">
                                    <td colspan="2" style="padding:1em; font-weight: 500; font-size: 11px; color:black;">
                                        <p class="uk-text-uppercase" style="margin:0;padding:0;font-weight: 500;">{{dtl.group_racikan}}</p>
                                    </td>
                                </template>
                                
                                <template v-else>
                                    <td style="padding:1em; font-weight: 500; font-size: 11px; color:black;width:100px;">
                                        <p class="uk-text-uppercase" style="margin:0;padding:0;font-weight: 500;">{{dtl.group_racikan}}</p>
                                    </td>    
