<template>
    <tr v-if="rowData" style="border-bottom:1px solid #ccc;">
        ...
        <td class="uk-text-uppercase">
            <p style="margin:0;padding:0;font-weight: 500;font-size:16px;">{{rowData.no_bed}}</p>
        </td>
        <td>
            <div style="margin:0;padding:0;">
                ...
                <a href="#" class="row-link-menu">
                    {{rowData.reg_id}}
                    <p style="margin:0;padding:0;font-weight:350;">{{rowData.tgl_masuk}}</p>
                </a>
        ...
        <td style="text-align: center;">
            <button v-if="rowData.status.toUpperCase() == 'DAFTAR'" @click.prevent = "lockCallback(rowData)">Konfirmasi</button>
            <button v-else @click.prevent = "linkCallback(rowData)">Detail</button>
        </td>
                            ...
                            <li style="padding:0;margin:0;">
                                <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0 0 0 0;">
                                    <thead>
                                        ...
                                        <th class="child-table-header" style="text-align:left;padding:1em;">Unit Ruang</th>
                                        <th class="child-table-header" style="text-align:left;padding:1em;">Ruang</th>
                                    ...
                                    <tbody>
                                        <tr v-for="trx in rowData.transactions">
                                            ...
                                            <td style="padding:1em; text-align:left;">
                                                <p style="margin:0;padding:0;">{{trx.unit_nama}}</p>
                                            </td>
                                            <td style="padding:1em; text-align:left;">
                                                <p style="margin:0;padding:0;font-weight:500;font-size:10px;">{{trx.ruang_nama}}</p>
                                            </td>
...
export default {
    props : {
        ...
        lockCallback : { type:Function, required:false, default:null }
    },
    emits : ['itemRequestSelected'],
    name : 'row-pelayanan-inap',
    data() {
        return {
            isExpanded : false,
            selectAll : true,
