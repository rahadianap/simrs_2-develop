                    ...
                    <div class="uk-width-1-1@s uk-grid-small" uk-grid> 
                        ...
                        <div class="uk-width-1-1@m">
                            <div style="padding:0 0 0.2em 0;">                                
                                <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0;">
                                    <thead>
                                        <th class="tb-header-reg" style="text-align:center;color:white;width:10px;background-color:#cc0202;"></th>
                                        <th class="tb-header-reg" style="text-align:center;color:white;background-color:#cc0202;">Tindakan</th>
                                        <th class="tb-header-reg" style="text-align:left;color:white;background-color:#cc0202;">Dokter</th>
                                        <th class="tb-header-reg" style="text-align:left;color:white;background-color:#cc0202;">Jumlah</th>
                                        <th class="tb-header-reg" style="width:40px;text-align:center;color:white;background-color:#cc0202;">Harga</th>
                                        <th class="tb-header-reg" style="text-align:center;color:white;background-color:#cc0202;">Diskon</th>
                                        <th class="tb-header-reg" style="width:80px;text-align:right;color:white;background-color:#cc0202;">Subtotal</th>
                                        <th class="tb-header-reg" style="width:60px;text-align:center;color:white;background-color:#cc0202;">
                        ...
                        <div class="uk-width-1-1@m">
                            <div style="padding:0 0 0.2em 0;">
                                <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0;">
                                    <thead>
                                        <th class="tb-header-reg" style="text-align:left;color:white;background-color:#cc0202;">Depo</th>
                                        <th class="tb-header-reg" style="text-align:left;color:white;background-color:#cc0202;">Item BHP</th>
                                        ...
                                        <th class="tb-header-reg" style="width:80px;text-align:right;color:white;background-color:#cc0202;">Subtotal</th>  
                                        <th class="tb-header-reg" style="width:80px;text-align:right;color:white;background-color:#cc0202;">Bhp Tind.</th>  
...
export default {
    ...
    methods : {          
        ...
        ...mapMutations('rawatInap',['CLR_INPATIENT_TRANSACTION','SET_INPATIENT_TRANSACTION','SET_ACTS_POLI','SET_ITEM_USAGE']),   
        
        formClosed() {
            this.clearTindakan();
            this.$router.push({ name : 'dataPasienRawatInap',params: { trxId: this.trxId } });
        },
        ...
        initData(){
            this.trxUnitId = this.inpatientTransaction.unit_id;
            this.dataUnitPelayanan(this.inpatientTransaction.unit_id).then((response) => {
                if (response.success == true) { 
                    this.isLoading = false;
                    ...
                    if(depo) { 
                        this.defaultDepo = JSON.parse(JSON.stringify(depo)); 
                    }
                    else { 
                        this.defaultDepo = JSON.parse(JSON.stringify(this.depoLists[0])); 
                    }
        ...
        retrieveDataPemeriksaan(){
            ...
            this.dataPemeriksaan(this.actId).then((response) => {
                if (response.success == true) {  
                    this.isLoading = false;
                    this.isUpdate = true;
                    if(response.data.status.toUpperCase() == 'DRAFT' || this.actId.toUpperCase() == 'BARU') { this.isDraft = true; }
        ...
        searchTindakan(){
            if(this.inpatientTransaction.unit_id == null || 
                this.inpatientTransaction.unit_id == '' || 
                this.inpatientTransaction.kelas_harga_id == null ||
                this.inpatientTransaction.kelas_harga_id == '') 
            {
                alert('Pilih unit pelayanan dan kelas terlebih dahulu.');
            }

            else {
                this.urlPicker = `units/${this.inpatientTransaction.unit_id}/acts`;
        ...
        tindakanSelected(dataSelected){        
            if(dataSelected) {
                ...
                let trxData = this.inpatientTransaction;
        ...
        clearTindakan(){
            ...
            this.tindakan.unit_id = this.inpatientTransaction.unit_id;
            this.tindakan.unit_nama = this.inpatientTransaction.unit_nama;
            this.tindakan.depo_id = null;
            this.tindakan.depo_nama = null;
            this.tindakan.bhp_tindakan = false;
            this.tindakan.kelas_harga_id = this.inpatientTransaction.kelas_harga_id;
            this.tindakan.buku_harga_id = this.inpatientTransaction.buku_harga_id;
            this.tindakan.nilai = 0;
            this.tindakan.diskon = 0;
            this.tindakan.diskon_persen = 0;
            this.tindakan.harga_diskon = 0;
            this.tindakan.subtotal = 0;            
            this.tindakan.dokter_pengirim_id = this.inpatientTransaction.dokter_pengirim_id;
        ...
        bhpSelected(data){
            if(data) {
                ...
                this.bhp.dokter_nama = this.inpatientTransaction.dokter_nama;
                this.bhp.dokter_id = this.inpatientTransaction.dokter_id;
             }
        },
