    ...
    <div style="padding:1em;">
        <div class="uk-grid-small" uk-grid>
            ...
            <div class="uk-width-expand" style="padding:0 0 1em 1em;">
                <h2 style="padding:0;margin:0;">KONFIRMASI ANTRIAN JKN</h2>
                <h5 style="padding:0;margin:0;">gunakan kode booking antrian anda dibawah ini: </h5>
            </div>
        </div>
            ...
            <form action="" @submit.prevent="searchKodeBooking">
                <div class="uk-grid-small" uk-grid>
                    <div class="uk-width-1-2" style="margin:0;padding-right:0;padding-left:0;">
                        <input class="uk-input uk-form-large input-text-jkn" type="text" v-model="keyword" placeholder="masukkan kode booking" required style="color:black;">
                    </div>
                    <div class="uk-width-1-2 uk-grid-small" uk-grid>
                        <div class="uk-width-auto@s" style="margin:0;padding-right:0; padding-left:0.5em;">
                            <button class="uk-button uk-button-large button-jkn-primer" type="submit">CARI</button>
                        </div>
                        <!-- <div class="uk-width-auto@s" style="margin:0;padding-right:0; padding-left:0;">
                            <button class="uk-button button-jkn" type="button" @click.prevent="returnMainPage">KEMBALI</button>
                        </div> -->
                    </div>
                </div>
            </form>
