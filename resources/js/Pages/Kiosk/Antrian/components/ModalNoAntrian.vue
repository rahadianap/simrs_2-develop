    ...
    <div class="uk-modal" uk-modal="bg-close:false;" :id="modalId">
        <div class="uk-modal-dialog">
            <div class="uk-modal-body">
                ...
                <div style="text-align:center;">
                    <div class="info-container" >
                        ...
                        <p class="content-info">{{ booking.kode_booking }}</p>
                    </div>
                    <div class="info-container">
            ...
            <div class="uk-modal-footer uk-text-center">
                ...
                <button class="uk-button modal-jadwal-button uk-modal-close" type="button" style="border:none;" @click.prevent="closeModalNoAntrian">SELESAI</button>
...
export default {
    ...
    methods : {
        init(){
            this.idModal = `modalNoAntrian-${Date.now()}`;
        },

        showModal(data){
            this.booking.nama_pasien = data.nama_pasien;
            this.booking.kode_booking = data.kode_booking;
            this.booking.no_antrian = data.no_antrian;
            this.booking.no_urut = data.no_urut;
        ...
        closeModalNoAntrian(){
            this.$emit('closedModalNoAntrian',true);
