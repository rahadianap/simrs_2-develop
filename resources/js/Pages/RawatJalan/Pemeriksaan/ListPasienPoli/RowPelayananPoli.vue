        ...
        <Transition>            
            <td colspan="9" v-if="isExpanded" style="background-color:whitesmoke;border-bottom:1px solid #eee;">
                <div style="padding:1em;margin:0;">
                    ...
                    <div> -->
                        <!-- <ul class="uk-tab hims-poli-tab" uk-switcher id="switcherDetailInap" style="padding:0;margin:0;">
                        ...
                        <ul class="uk-switcher">
                            ...
                            <li style="padding:0;margin:0;"> -->
                                <div style="margin-top:2em;">
                                    <h5 style="font-weight:500;padding:0 0 1em 0;margin:0;" class="uk-width-expand">DETAIL PEMERIKSAAN</h5>
                                </div>
                                <div>
                                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:1em 0 0 0;">
                                        <thead>
                                            ...
                                            <th class="child-table-header" style="text-align:right;padding:1em;">Total</th>
                                        </thead>
                                        <tbody>
