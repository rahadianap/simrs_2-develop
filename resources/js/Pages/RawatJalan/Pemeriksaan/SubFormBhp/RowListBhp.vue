                ...
                <div style="padding:0.5em;background-color:white;">
                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0;">
                        <thead>
                            ...
                            <th class="tb-header-reg-sub" style="text-align:left;color:black;">Item Bhp</th>
                            <th class="tb-header-reg-sub" style="width:60px;text-align:center;color:black;">Satuan</th>
                            <th class="tb-header-reg-sub" style="width:40px;text-align:center;color:black;">Jumlah</th>
                            <th class="tb-header-reg-sub" style="width:80px;text-align:right;color:black;">Harga</th>
                            <th class="tb-header-reg-sub" style="width:80px;text-align:right;color:black;">Subtotal</th>                                                
                            <th class="tb-header-reg-sub" style="width:60px;text-align:center;color:black;">...</th>
                        </thead>
                        <tbody>
                            <tr v-if="rowData.detail" v-for="dtl in rowData.detail" style="border-bottom:1px solid #ccc;" v-bind:class="dtl.is_aktif != true ? 'inaktif':'' ">        
                                <td style="padding:1em; font-weight: 500; font-size: 12px; color:black;">
                                    <p class="uk-text-uppercase" style="margin:0;padding:0;font-weight: 500;">{{dtl.item_id}}</p>
                                </td>
                                <td style="padding:1em; font-weight: 500; font-size: 12px; color:black;">
                                ...
                                <td style="width:60px;padding:1em; font-size: 12px; text-align:right; color:black;">{{formatCurrency(dtl.nilai)}}</td>
                                <td style="width:80px;padding:1em; font-size: 12px; text-align:right; color:black;">{{formatCurrency(dtl.subtotal)}}</td>
