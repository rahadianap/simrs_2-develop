    ...
    <!-- <div style="padding:0;margin:0;">         -->
        <div class="uk-grid-small" uk-grid style="padding:0.5em 1em 0.5em 0;margin:0;">            
            <div class="uk-width-auto@m">
                <button type="button" style="margin-top:0.2em;" @click.prevent="fnAddCallback">Tambah SOAP</button>
            </div>
            <!-- <div class="uk-width-auto@m">
                <div class="uk-inline">
                    <button type="button" style="margin-top:0.2em; padding:0.5em;">General Consent</button>
                    <div uk-dropdown>
...
import RowListAsesmen from '@/Pages/RawatJalan/Pemeriksaan/ListPemeriksaan/RowListAsesmen.vue';
import QuestionaireForm from '@/Pages/RawatJalan/Pemeriksaan/components/QuestionaireForm.vue';

export default {
    name : 'sub-list-asesmen',
    props : {
    ...
    computed : {
        ...mapGetters('rawatJalan',['poliTransaction','poliExamination','poliAssesments']),       
