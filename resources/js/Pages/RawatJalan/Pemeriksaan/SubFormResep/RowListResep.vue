                ...
                <div style="padding:0.5em;background-color:white;">
                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0;">
                        <thead>
                            ...
                            <th class="tb-header-reg-sub" style="font-size:11px;text-align:left;color:black;">Item Resep</th>
                            <th class="tb-header-reg-sub" style="font-size:11px;text-align:left;color:black;">Signa</th>
                        ...
                        <tbody>
                            <tr v-if="rowData.detail" v-for="dtl in rowData.detail" style="border-bottom:1px solid #ccc;" v-bind:class="dtl.is_aktif != true ? 'inaktif':'' ">        
                                <td style="padding:1em; font-weight: 500; font-size: 11px; color:black;">
                                    <p style="margin:0;padding:0;font-weight: 500;">{{dtl.item_nama}}</p>
                                    <p style="font-size:10px; margin:0;padding:0;font-weight: 400;">{{dtl.item_id}}</p>
                                </td>
                                <!-- <td style="padding:1em; font-weight: 500; font-size: 11px; color:black;">
                                    <p style="margin:0;padding:0;font-weight: 400;">{{dtl.item_nama}}</p>
                                </td> -->
                            ...
                            <tr>
                                ...
                                <td style="font-size:14px;font-weight:500;text-align:right;color:black;padding:0.5em;">{{formatCurrency(rowData.total)}}</td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
