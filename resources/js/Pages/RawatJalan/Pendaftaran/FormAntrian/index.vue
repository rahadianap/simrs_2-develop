<template>
    <div class="uk-container">
        <div style="margin:0;padding:1em;">
            <header-page title="REGISTRASI ANTRIAN POLI" subTitle="pendaftaran konsultasi dokter poli."></header-page>
        </div> 
        <div style="padding:0.5em 1em 1em 1em; margin:0;background-color: #fff;">
            <form action="" @submit.prevent="submitAdmisiPoli" style="margin:0;padding:0;">
                    ...
                    <div class="hims-form-container" style="padding:0 1.5em 2em 1.5em; margin:0;">     
                        <div class="uk-grid-small hims-form-subpage" uk-grid  style="border:none;">                        
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">  
                                <div v-if="!isUpdate" class="uk-width-auto" style="margin-left:1em;">
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">      
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="date" v-model="registrasi.tgl_periksa" style="color:black;" required :min="minDate" @change="getTodayUnit"  disabled>
                                    </div>
                                </div>
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <select v-model="registrasi.kelas_harga_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;" @change.prevent="kelasHargaChanged">
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            <div class="uk-width-1-4@m" style="padding:0 0.5em 1em 0.5em;">
                                <h5 style="color:indigo;padding:0;margin:0;">GENERAL CONSENT SATUSEHAT</h5>
                                <p style="font-size:12px;font-style:italic;padding:0;margin:0;">
                                    persetujuan pasien untuk data SATUSEHAT.
                                </p>
                            </div>
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                <div class="uk-width-1-1@m" style="margin:0;padding:0.5em 0.2em 0.2em 1.2em;">
                                    <div class="uk-form-controls">
                                        <label style="color:black; font-size:14px; font-weight: bold;">
                                            <input class="uk-checkbox" type="checkbox" value="1" v-model="pasien.is_satusehat" > Saya menjamin bahwa pasien sudah membaca dan menandatangani consent pembukaan data dari SATUSEHAT.
                                        </label>
                                    </div>
                                </div>
                            </div>
        ...
        <modal-form-pasien v-if="!isUpdate" ref="modalFormPasien" v-on:modalFormPasienClosed="refreshPasien"></modal-form-pasien>
        <modal-pasien v-if="!isUpdate" ref="modalPasien" 
...
export default {
    ...
    methods : {
        ...
        ...mapActions('pendaftaran',['createRegistrasi','dataRegistrasi','updateRegistrasi','listUnitToday','deleteRegistrasi']),
        ...
        returnBookingList(){
            this.$router.push({ name: 'listPendaftaran' })
        },
        ...
        editData() {
            ...
            this.isLoading = true;
            if(this.bookingId) {
                this.dataRegistrasi(this.bookingId).then((response) => {
                    if (response.success == true) {
        ...
        fillPasien(data) {
            ...
            this.pasien.is_satusehat = data.is_satusehat;
        ...
        clearRegistrasi() {
            ...
            this.registrasi.mode_reg = 'WALK IN';
        ...
        hapusBooking(){
            this.CLR_ERRORS();
            if(confirm(`Proses ini akan menghapus data registrasi ${this.registrasi.trx_id} - ${this.pasien.nama_pasien}. Lanjutkan ?`)){
                this.isLoading = true;
                this.deleteRegistrasi(this.registrasi.trx_id).then((response) => {
                    if (response.success == true) {
                        this.isLoading = false; this.isUpdate = false;
                        alert('data antrian rawat jalan BERHASIL dihapus.');
                        this.modalClosed();
                    }
                    else { 
                        alert(response.message); 
        ...
        saveConfirmData(){
            this.confirmRegistrasi(this.registrasi).then((response) => {
                if (response.success == true) {
                    this.isLoading = false; this.isUpdate = false;
                    alert('data antrian BERHASIL dikonfirmasi.');
                    this.modalClosed();
                }
                else { 
                    alert(`Data antrian tidak berhasil dikonfirmasi. ${response.message}`); 
                    this.isLoading = false;
                }
            })
        },
