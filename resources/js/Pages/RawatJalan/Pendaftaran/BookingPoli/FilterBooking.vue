<template>
    ...
    <div class="uk-width-1-2@m">
        ...
        <div class="uk-form-controls">
            <input type="date" name="tgl_periksa_start" v-model="bookingFilterTable.tgl_periksa_start" class="uk-input uk-form-small" style="color:black;">
        </div>
    </div>
    <div  class="uk-width-1-2@m">               
        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tgl Periksa Akhir</label>         
        <div class="uk-form-controls">
            <input type="date" name="tgl_periksa_end" v-model="bookingFilterTable.tgl_periksa_end" class="uk-input uk-form-small" style="color:black;">
        </div>
    </div>
    ...
    <div class="uk-width-1-1">          
        <search-list
            ...
            :value = "bookingFilterTable.dokter"
    ...
    <div class="uk-width-1-1">
        ...
        <div class="uk-form-controls">
            <select name="status" v-model="bookingFilterTable.status" class="uk-select uk-form-small">
                <option></option>
...
export default {
    ...
    computed : {
        ...mapGetters(['errors']),
        ...mapGetters('booking',['bookingFilterTable']),
    ...
    methods : {
        ...
        init(){
            ...
            if(this.bookingFilterTable.tgl_periksa_end == null) {
                this.bookingFilterTable.tgl_periksa_end = this.getTodayDate();
            }

            if(this.bookingFilterTable.tgl_periksa_start == null) {
                this.bookingFilterTable.tgl_periksa_start = this.getTodayDate();
            }
        ...
        unitSelected(data) {
            this.bookingFilterTable.unit = null;
            if(data) {
                this.bookingFilterTable.unit = data.unit_id;
            }
        },
        dokterSelected(data) {
            this.bookingFilterTable.dokter = null;
            if(data) {
                this.bookingFilterTable.dokter = data.dokter_id;
            }
        }
    }
}
