<template>
    ...
    <div class="uk-width-1-1">          
        <search-list3
            ...
            :value = "regFilterTable.nama_unit"
    ...
    <div class="uk-width-1-1">          
        <search-list3
            ...
            :value = "regFilterTable.nama_dokter"
...
export default {
    ...
    methods : {
        ...
        unitSelected(data) {
            ...
            this.regFilterTable.nama_unit = null;
            if(data) {
                this.regFilterTable.unit = data.unit_id;
                this.regFilterTable.nama_unit = data.unit_nama;
            }
        },
        dokterSelected(data) {
            this.regFilterTable.dokter = null;
            this.regFilterTable.nama_dokter = null;
            if(data) {
                this.regFilterTable.dokter = data.dokter_id;
                this.regFilterTable.nama_dokter = data.dokter_nama;
