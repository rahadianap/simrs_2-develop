<template>
    <div v-if="showComponentAlertSuccess" id="alertSuccess" style="padding:1rem" class="alert-overlay uk-flex uk-flex-center uk-align-center">
            <!-- BOX ALERT SUCCESS -->
            <div class="box-alert-success uk-flex-middle uk-flex-center uk-flex">
                <div class="uk-padding uk-padding-remove-vertical uk-width-1-1">
                    <div class="uk-flex uk-flex-column">
                        <div class="uk-margin-medium-top uk-margin-small-bottom uk-flex uk-flex-center">
                            <font-awesome-icon v-if="iconSuccess" :icon="['far', 'circle-check']" size="xl" class="icon-alert-success" style="height:82px;color: #2BD09F;" /> 
                            <font-awesome-icon v-else-if="iconFailed" :icon="['far', 'circle-xmark']" size="xl" class="icon-alert-success" style="height:82px;color: #2BD09F;" />       
                        ...
                        <div class="uk-padding-small uk-flex uk-flex-center"> 
                            <div class="uk-flex uk-padding-small">
                                <div class="uk-flex-middle">
                                    <button class="alert-button lato-md-14-regular" type="button"  @click="tutupAlert">{{confirmSuccess}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    name: "alert-success",
    props: {
        showComponentAlertSuccess: Boolean,        
        titleSuccess: String,
