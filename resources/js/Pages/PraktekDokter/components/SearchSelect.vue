...
<template>
    <div :class="config.compClass" ref="containerSearchSelect" :style="config.compStyle" class="mySearchSelectContainer">
        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;color:black;">{{label}}</label>
        <div class="uk-form-controls search-select-input">
            <div class="uk-inline uk-width-1-1">
                <input ref="inputSearchSelect" class="uk-input uk-form-small" type="text" v-bind:style="config.compStyle" style="background-color:white; color:black;padding-left:10px;border:1px solid #aaa;border-radius:7px; font-weight: 400;"
