<template>
    <!-- Popup Modal tambah data kategori -->
    <div class="uk-modal-container" uk-modal="bg-close:false;" id="formKategori" style="min-height:50vh;">
        <div class="uk-modal-dialog uk-modal-body">
            <div class="uk-container hims-form-container" style="min-height:50vh; background-color:#fff;">
                <form action="" @submit.prevent="submitKategori" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">TAMBAH DATA KATEGORI</h5>
                        </div>                                
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid >
                            ...
                            <div class="uk-width-1-1@s uk-grid-small" uk-grid> 
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="assets.nomor_asset" type="text" placeholder="masukkan ID client" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-3@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="assets.nomor_seri" type="text" placeholder="masukkan ID client" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-3@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Group Asset</label>
                                    <div class="uk-form-controls">
                                        <select v-model="assets.group_asset" class="uk-select uk-form-small" required>
...
export default {
    ...
    methods : {
        ...mapActions('asset',['createKategori','updateKategori','dataKategori']),
        ...mapMutations(['CLR_ERRORS']),

        closeModal(){
            this.$emit('closed',true);
            UIkit.modal('#formKategori').hide();
            return false;
        },
        ...
        submitKategori(){
            this.CLR_ERRORS();
            if(!this.isUpdate) {
                this.createKategori(this.assets).then((response) => {
                    if (response.success == true) {
                        alert("Data Asset baru berhasil dibuat.");
                        // this.fillKategori(response.data);
                        this.clearKategori();
                ...
                this.updateKategori(this.assets).then((response) => {
                    if (response.success == true) {
                        // this.fillKategori(response.data);
                        ...
                        this.$emit('saveSucceed',true);
                        this.isUpdate = false;
                        UIkit.modal('#editFormKategori').hide();
                        this.closeModal();
                    }
                })
            }            
        ...
        newKategori(){
            this.clearKategori();
            this.isUpdate = false;
            UIkit.modal('#formKategori').show();
        },

        editKategori(asset_id){
            console.log(444);
            this.clearKategori();            
            this.dataKategori(asset_id).then((response)=>{
                if (response.success == true) {
                    this.fillKategori(response.data);
                    this.isUpdate = true;
                    UIkit.modal('#editFormKategori').show();
                } else {
