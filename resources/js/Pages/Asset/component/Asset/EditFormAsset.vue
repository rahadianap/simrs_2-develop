                    ...
                    <div style="margin:0 10px;border-top:2px solid #cc0202;">                  
                        ...
                        <div class="uk-grid-small hims-form-subpage-asset" style="margin:30px 0" uk-grid>
                            ...
                            <div class="uk-width-1-1@s uk-grid-small" style="margin-left:1px;padding-left:1px;" uk-grid> 
                                ...
                                <!-- nomor asset -->
                                <div class="uk-width-1-2@m" style="padding-left:1px;padding-right: 10px">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">No. Asset*</label>
                                    <div class="uk-form-controls">
                                ...
                                <div class="uk-width-1-2@m" style="padding-left:1px;padding-right: 10px">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="assets.nama_asset" type="text" placeholder="masukkan nama asset" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-2@m" style="padding-left:1px;padding-right: 10px">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="assets.masa_pakai" type="number" placeholder="masukkan masa pakai asset" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-2@m" style="padding-left:1px;padding-right: 10px">
                                    ...
                                    <div class="uk-form-controls">
                                        ...
                                        <input class="uk-input uk-form-small" v-model="assets.tgl_pemakaian" type="date">
...
export default {
    ...
    methods : {
        ...
        fillAsset(data){
            ...
            this.assets.tgl_perolehan = data?.tgl_perolehan.slice(0,10);
            this.assets.tgl_pemakaian = data?.tgl_pemakaian.slice(0,10);
