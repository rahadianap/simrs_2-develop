<template>
    <!-- Popup Modal EDIT data sparepart -->
    <div class="uk-modal-container" uk-modal="bg-close:false;" id="editformSparepart" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitSparepart" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" style="border-radius:10px;justify-content:center;text-align:center;" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 1em 0.1em;margin:0;">
                            <h5 class="uk-text-uppercase">EDIT DATA SPAREPART</h5>
                        </div>                                
                    </div>
...
export default {
    ...
    mounted() {
        // this.createSparepart();
        // this['Spareparts/form-Sparepart']();
        // try {
        // }
    },
    ...
    methods : {
        ...
        clearSparepart(){
            this.spareparts.sparepart_id = null;
            ...
            this.spareparts.is_aktif = null;
            this.spareparts.client_id = null;
        },

        fillSparepart(data){
            this.spareparts.sparepart_id = data.sparepart_id;
