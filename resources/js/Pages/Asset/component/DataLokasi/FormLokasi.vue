                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid >
                            ...
                            <div class="uk-width-1-1@s uk-grid-small" uk-grid> 
                                ...
                                <div class="uk-width-1-1@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <textarea input class="uk-input uk-textarea" v-model="assets.deskripsi" type="text" placeholder="deskripsi lokasi" required></textarea>
                                    </div>
                                </div>

                                <div class="uk-width-1-1" style="padding:0.5em 1em 0.2em 0.8em;margin:0;">
                                    <label style="padding:0;margin:0;font-size:12px;"><input class="uk-checkbox" type="checkbox" v-model="assets.is_aktif" style="margin-left:5px;"> Data Lokasi aktif</label>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods : {
        ...
        submitLokasi(){
            this.CLR_ERRORS();
            if(!this.isUpdate) {
                this.createLokasi(this.assets).then((response) => {
                ...
                this.updateLokasi(this.assets).then((response) => {
                    if (response.success == true) {
                        // this.fillAsset(response.data);
        ...
        editLokasi(asset_id){
            console.log(444);
            this.clearLokasi();            
            this.dataLokasi(asset_id).then((response)=>{
                if (response.success == true) {
