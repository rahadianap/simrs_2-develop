                            ...
                            <div class="uk-width-1-1@s uk-grid-small" uk-grid> 
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="refDataGroup.value" type="text" placeholder="masukkan ID client" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="refDataGroup.text" type="text" placeholder="masukkan ID client" required>
                                    </div>
                                </div>
...
export default {
    ...
    methods : {
            ...
            if(!this.isUpdate) {
                this.updateRefAset(data).then((response) => {
                    if (response.success == true) {
                        alert("Data Kategori baru berhasil dibuat.");
                ...
                this.updateKategori(data).then((response) => {
                    if (response.success == true) {
                        // this.fillKategori(response.data);
        ...
        editKategori(ref_id){
                this.clearKategori();            
                this.dataKategori(ref_id).then((response)=>{
                    if (response.success == true) {
                        // this.fillKategori(response.data);
                        this.isUpdate = true;
                        UIkit.modal('#editFormKategori').show();
