<template>
    <!-- Popup Modal EDIT data kategori -->
    <div class="uk-modal-container" uk-modal="bg-close:false;" id="editFormKategori" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitKategori" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">EDIT DATA KATEGORI</h5>
                        </div>                                
...
export default {
    ...
    methods : {
        ...mapActions('asset',['createKategori','updateKategori','dataAsset']),
