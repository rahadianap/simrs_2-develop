...
export default {
    ...
    methods : {
        ...
        addDataGroup(){
            if(this.refDataGroup.value == null || this.refDataGroup.value == '' || this.refDataGroup.text == null || this.refDataGroup.text == ''  ){
                ...
                data.ref_data.push(this.refDataGroup);
                this.submitData(data);
            }
        },

        addDataStatus(){
            if(this.refDataStatus.value == null || this.refDataStatus.value == '' || this.refDataStatus.text == null || this.refDataStatus.text == ''  ){
                alert('Data tidak lengkap.');
                return false;
            }
            else {
                ...
                data.ref_data.push(this.refDataStatus);
                this.submitData(data);
            }
        },
