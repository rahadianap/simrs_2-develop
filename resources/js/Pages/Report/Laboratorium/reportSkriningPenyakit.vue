<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="reportSkriningPenyakit" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">LAPORAN SKIRINING PENYAKIT PASIEN</h5>
                        </div>                                
...
<script>
    ...
    export default {
        ...
        methods : {
            ...mapActions('report',['skriningPenyakit']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#reportSkriningPenyakit').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#reportSkriningPenyakit').show();
            },
            ...
            cetakData(){
                ...
                // this.skriningPenyakit(this.params).then((response) => {
                this.skriningPenyakit().then((response) => {
