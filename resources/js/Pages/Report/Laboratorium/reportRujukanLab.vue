<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="reportRujukaLab" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">LAPORAN RUJUKAN LAB</h5>
                        </div>                                
                    ...
                    <div class="uk-width-1-1@m uk-grid-small" uk-grid style="padding:0.5em;">                           
                        <div class="uk-width-1-2@m">
                            ...
                            <div class="uk-form-controls">
                                <input id="start_date_rujukan_lab" type="date" name="start_date_rujukan_lab" class="uk-input uk-form-small uk-width-auto text-keyword-simple" style="border:none;height:33px;margin-left:10px;" placeholder="Start Date" required>
                            </div>
                        </div>
                        <div class="uk-width-1-2@m">
                            <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">End Date</label>
                            <div class="uk-form-controls">
                                <input id="end_date_rujukan_lab" type="date" name="end_date_rujukan_lab" class="uk-input uk-form-small uk-width-auto text-keyword-simple" style="border:none;height:33px;margin-left:10px;" placeholder="End Date" required>
                            </div>
                        </div>
                    </div>
                </form>                          
...
<script>
    ...
    export default {
        ...
        methods : {
            ...mapActions('report',['rujukanLab']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#reportRujukaLab').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#reportRujukaLab').show();
            },
            ...
            cetakData(){
                ...
                this.params = [
                    {
                        'start_date_rujukan_lab': document.getElementById('start_date_rujukan_lab').value,
                        'end_date_rujukan_lab': document.getElementById('end_date_rujukan_lab').value,
                    }
                ];
