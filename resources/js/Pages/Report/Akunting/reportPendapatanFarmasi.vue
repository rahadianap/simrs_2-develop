<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="reportPendapatanFarmasi" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">LAPORAN PENDAPATAN FARMASI</h5>
                        </div>                                
                    ...
                    <div class="uk-width-1-1@m uk-grid-small" uk-grid style="padding:0.5em;">                           
                        <div class="uk-width-1-2@m">
                            ...
                            <div class="uk-form-controls">
                                <input type="date" name="start_date_pendapatan_farmasi" id="start_date_pendapatan_farmasi" class="uk-input uk-form-small" style="color:black;">
                            </div>
                        </div>
                        <div  class="uk-width-1-2@m">               
                            <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tgl Periksa Akhir</label>         
                            <div class="uk-form-controls">
                                <input type="date" name="end_date_pendapatan_farmasi" id="end_date_pendapatan_farmasi" class="uk-input uk-form-small" style="color:black;">
                            </div>
                        </div>
                    </div>
                </form>                          
...
<script>
    ...
    export default {
        name : 'report-pendapatan-farmasi', 
        components : {
            headerPage,
            BaseRow,
        },
        ...
        methods : {
            ...mapActions('report',['pendapatanFarmasi']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#reportPendapatanFarmasi').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#reportPendapatanFarmasi').show();
            },
            ...
            cetakData(){
                ...
                this.params = [
                    {
                        'start_date_pendapatan_farmasi': document.getElementById('start_date_pendapatan_farmasi').value,
                        'end_date_pendapatan_farmasi': document.getElementById('end_date_pendapatan_farmasi').value,
                    }
                ];
                // Tempat untuk mengirim parameter
                this.pendapatanFarmasi(this.params).then((response) => {
