<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="reportHarianKasirRanap" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">LAPORAN HARIAN KASIR RAWAT INAP</h5>
                        </div>                                
                    ...
                    <div class="uk-width-1-1@m uk-grid-small" uk-grid style="padding:0.5em;">                           
                        <div class="uk-width-1-2@m">
                            ...
                            <div class="uk-form-controls">
                                <input type="date" name="start_date_harian_ranap" id="start_date_harian_ranap" class="uk-input uk-form-small" style="color:black;">
                            </div>
                        </div>
                        <div  class="uk-width-1-2@m">               
                            <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tgl Periksa Akhir</label>         
                            <div class="uk-form-controls">
                                <input type="date" name="end_date_harian_ranap" id="end_date_harian_ranap" class="uk-input uk-form-small" style="color:black;">
                            </div>
                        </div>
                    </div>
                </form>                          
...
<script>
    ...
    export default {
        name : 'report-harian-kasir-ranap', 
        components : {
            headerPage,
            BaseRow,
        },
        ...
        methods : {
            ...mapActions('report',['harianKasirRanap']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#reportHarianKasirRanap').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#reportHarianKasirRanap').show();
            },
            ...
            cetakData(){
                ...
                this.params = [
                    {
                        'start_date_harian_ranap': document.getElementById('start_date_harian_ranap').value,
                        'end_date_harian_ranap': document.getElementById('end_date_harian_ranap').value,
                    }
                ];
                // Tempat untuk mengirim parameter
                this.harianKasirRanap(this.params).then((response) => {
