<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="reportPendapatanHarianKasir" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">LAPORAN PENDAPATAN HARIAN KASIR</h5>
                        </div>                                
...
<script>
    ...
    export default {
        name : 'report-pendapatan-harian-kasir', 
        components : {
            headerPage,
            BaseRow,
        },
        ...
        methods : {
            ...mapActions('report',['pendapatanHarianKasir']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#reportPendapatanHarianKasir').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#reportPendapatanHarianKasir').show();
            },
            ...
            cetakData(){
                ...
                // this.pendapatanHarianKasir(this.params).then((response) => {
                this.pendapatanHarianKasir().then((response) => {
