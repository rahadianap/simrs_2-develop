<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="cetakanUangMukaPasien" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">CETAKAN UANG MUKA PASIEN</h5>
                        </div>                                
                    ...
                    <div class="uk-width-1-2@m uk-grid-small" uk-grid style="padding:0.5em;">                           
                        <div class="uk-width-1-1@m">
                            ...
                            <div class="uk-form-controls">
                                <input id="no_rm" type="text" name="no_rm" v-model="cetakanUangMukaPasien.no_rm" class="uk-input uk-form-small uk-width-auto text-keyword-simple" style="border:none;height:33px;margin-left:10px;" placeholder="No. RM" required>
                            </div>
                        </div>
                    </div>
                </form>                          
...
<script>
    ...
    export default {
        ...
        methods : {
            ...mapActions('cetakan',['cetakUangMukaPasien']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#cetakanUangMukaPasien').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#cetakanUangMukaPasien').show();
            },
            ...
            cetakData(){
                ...
                this.params = [
                    {
                        'no_rm': this.cetakanUangMukaPasien.no_rm,
                    }
                ];
                // Tempat untuk mengirim parameter
                this.cetakUangMukaPasien(this.params).then((response) => {
