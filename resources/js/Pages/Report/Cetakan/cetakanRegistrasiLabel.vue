<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="cetakanRegistrasiLabel" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">CETAKAN REGISTRASI LABEL</h5>
                        </div>                                
                    ...
                    <div class="uk-width-1-2@m uk-grid-small" uk-grid style="padding:0.5em;">                           
                        <div class="uk-width-1-1@m">
                            ...
                            <div class="uk-form-controls">
                                <input id="no_rm" type="text" name="no_rm" class="uk-input uk-form-small uk-width-auto text-keyword-simple" style="border:none;height:33px;margin-left:10px;" placeholder="No. RM" required>
                            </div>
                        </div>
                    </div>
                </form>                          
...
<script>
    ...
    export default {
        ...
        methods : {
            ...mapActions('cetakan',['dataRegistrasiLabel']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#cetakanRegistrasiLabel').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#cetakanRegistrasiLabel').show();
            },
            ...
            cetakData(){
                ...
                // this.registrasiLabel(this.params).then((response) => {
                this.dataRegistrasiLabel(this.params).then((response) => {
                    var newNode = document.createElement('p');
                    newNode.appendChild(document.createTextNode('html string'));
                    this.printDiv(response,"1.0in 3.0in");
                });
            },
