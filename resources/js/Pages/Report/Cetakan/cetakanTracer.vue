<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="cetakanTracer" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">CETAKAN TRACER</h5>
                        </div>                                
...
<script>
    ...
    export default {
        ...
        methods : {
            ...mapActions('report',['tracer']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#cetakanTracer').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#cetakanTracer').show();
            },
            ...
            cetakData(){
                ...
                // this.tracer(this.params).then((response) => {
                this.tracer().then((response) => {
