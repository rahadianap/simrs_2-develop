<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="cetakanRingkasanMasukKeluar" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">CETAKAN RINGKASAN MASUK KELUAR</h5>
                        </div>                                
...
<script>
    ...
    export default {
        name : 'cetakan-ringkasan-masuk-keluar', 
        components : {
            headerPage,
            BaseRow,
        },
        ...
        methods : {
            ...mapActions('report',['ringkasanMasukKeluar']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#cetakanRingkasanMasukKeluar').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#cetakanRingkasanMasukKeluar').show();
            },
            ...
            cetakData(){
                ...
                // this.ringkasanMasukKeluar(this.params).then((response) => {
                this.ringkasanMasukKeluar().then((response) => {
