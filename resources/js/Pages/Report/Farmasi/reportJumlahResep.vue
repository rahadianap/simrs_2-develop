<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="reportJumlahResep" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">LAPORAN JUMLAH RESEP</h5>
                        </div>                                
                    ...
                    <div class="uk-width-1-1@m uk-grid-small" uk-grid style="padding:0.5em;">                           
                        <div class="uk-width-1-2@m">
                            ...
                            <div class="uk-form-controls">
                                <input type="date" name="start_date_jml_resep" id="start_date_jml_resep" class="uk-input uk-form-small" style="color:black;">
                            </div>
                        </div>
                        <div  class="uk-width-1-2@m">               
                            <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tgl Periksa Akhir</label>         
                            <div class="uk-form-controls">
                                <input type="date" name="end_date_jml_resep" id="end_date_jml_resep" class="uk-input uk-form-small" style="color:black;">
                            </div>
                        </div>
                    </div>
                </form>                          
...
<script>
    ...
    export default {
        ...
        methods : {
            ...mapActions('report',['jumlahResep']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#reportJumlahResep').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#reportJumlahResep').show();
            },
            ...
            cetakData(){
                ...
                this.params = [
                    {
                        'start_date_jml_resep': document.getElementById('start_date_jml_resep').value,
                        'end_date_jml_resep': document.getElementById('end_date_jml_resep').value,
                    }
                ];
                // Tempat untuk mengirim parameter
                this.jumlahResep(this.params).then((response) => {
