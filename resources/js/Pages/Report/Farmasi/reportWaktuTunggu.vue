<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="reportWaktuTunggu" style="min-height:50vh;">
                ...
                <form action="" @submit.prevent="submitReport" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">LAPORAN WAKTU TUNGGU PASIEN</h5>
                        </div>                                
...
<script>
    ...
    export default {
        ...
        methods : {
            ...mapActions('report',['waktuTunggu']),
            ...mapMutations(['CLR_ERRORS']),

            closeModalReport(){
                this.$emit('closed',true);
                UIkit.modal('#reportWaktuTunggu').hide();
            },

            filterReport(){
                this.isUpdate = false;
                UIkit.modal('#reportWaktuTunggu').show();
            },
            ...
            cetakData(){
                ...
                // this.waktuTunggu(this.params).then((response) => {
                this.waktuTunggu().then((response) => {
