<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="filterPenerimaanBarangMedis" style="min-height:50vh;">
                    ...
                    <div class="uk-width-1-2@m uk-grid-small" uk-grid style="padding:0.5em;">                           
                        <div class="uk-width-1-1@m">
                            ...
                            <div class="uk-form-controls">
                                <input id="start_date1" type="date" name="start_date" class="uk-input uk-form-small uk-width-auto text-keyword-simple" style="border:none;height:33px;margin-left:10px;" placeholder="Start Date" required>
                            </div>
                        </div>
                        <div class="uk-width-1-1@m">
                            <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">End Date</label>
                            <div class="uk-form-controls">
                                <input id="end_date1" type="date" name="end_date" class="uk-input uk-form-small uk-width-auto text-keyword-simple" style="border:none;height:33px;margin-left:10px;" placeholder="End Date" required>
                            </div>
                        </div>
                    </div>
                </form>                          
        ...
        <report-penerimaan-barang-medis ref="reportPenerimaanBarangMedis"></report-penerimaan-barang-medis>
    </div> 
</template>
...
<script>
    ...
    import reportPenerimaanBarangMedis from '@/Pages/Report/Logistik/reportPenerimaanBarangMedis.vue';
    
    export default {
        name : 'filter-penerimaan-barang-medis', 
        components : {
            headerPage,
            BaseRow,
            reportPenerimaanBarangMedis
        },
        computed : {
            ...mapGetters(['errors']),
        },
        ...
        methods : {
            ...mapActions('report',['penerimaanMedis']),
            ...
            cetakData(){
                ...
                this.penerimaanMedis(this.params).then((response) => {
                    if (response.success == true) {
                        this.$refs.reportPenerimaanBarangMedis.generateReport(response.data);
                    }
