<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="formJabatan" style="min-height:50vh;">
...
export default {
    ...
    methods : {
        ...
        //             // Tambahkan data jabatan ke array riwayatJabatan di komponen induk
        //             this.riwayatJabatan.push(response.data);
        ...
        //             // Perbarui data jabatan dalam array riwayatJabatan di komponen induk
        //             const index = this.riwayatJabatan.findIndex(jabatan => jabatan.hr_jabatan_id === response.data.hr_jabatan_id);
        //             if (index !== -1) {
        //             this.riwayatJabatan.splice(index, 1, response.data);
        //             }
