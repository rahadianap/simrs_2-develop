<template>
    <tr v-if="rowData" style="border-bottom:1px solid #ccc;"  v-bind:class="rowData.is_aktif != true ? 'inaktif':'' ">   
        ...
        <td style="padding:1em; font-weight: 500; font-size: 12px; color:black;">
            <p class="uk-text-uppercase1" style="margin:0;padding:0;font-weight: 500;">{{rowData.dokter_nama}}</p>
            <p class="uk-text-uppercase1" style="margin:0;padding:0;font-weight: 400;">{{rowData.unit_nama}}</p>
        </td>
            ...
            <td colspan="7" v-if="isExpandedReg" style="background-color:#fff;border-top:0px solid #000;padding:0;margin:0;">
                <div style="padding:0.5em;background-color:white;">
                    <table class="uk-table uk-table-striped1 child-table1" style="padding:0;margin:0;">
                        <thead>
                            <th class="tb-header-reg-sub" style="width:100px;font-size:12px;color:black;">Jenis</th>
                            <th class="tb-header-reg-sub" style="font-size:12px;color:black;">Item Pemeriksaan</th>
                            <th class="tb-header-reg-sub" style="font-size:12px;text-align:center;color:black;">Jumlah</th>
                            <th class="tb-header-reg-sub" style="font-size:12px;text-align:left;color:black;">Satuan</th>
                        </thead>
                        <tbody>
                            <tr v-if="rowData.detail" v-for="dtl in rowData.detail" style="border-bottom:1px solid #ccc;" v-bind:class="dtl.is_aktif != true ? 'inaktif':'' ">        
                                <td style="width:100px;padding:1em; font-size: 11px; color:black;">
                                    <p style="margin:0;padding:0;font-weight: 500;">{{ dtl.jenis }}</p>
                                </td>
