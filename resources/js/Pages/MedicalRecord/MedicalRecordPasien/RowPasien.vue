<template>
    <tr v-if="rowData" style="border-top:1px solid #ccc;">
        ...
        <td>
            <div class="uk-inline" style="margin:0;padding:0;">
                <a href="#" class="row-link-menu">
                    {{rowData.no_rm}}
                    <p style="margin:0;padding:0;font-weight:350;">{{rowData.pasien_id}}</p>
        ...
        <td class="">
            <p class="uk-text-uppercase" style="margin:0;padding:0;font-weight: 500;">
                {{rowData.nama_lengkap}} ({{ rowData.jns_kelamin }})
            </p>
            <p style="margin:0;padding:0;font-weight:350;">{{rowData.tempat_lahir}} , {{dateFormatting(rowData.tgl_lahir)}}</p>
        </td>
        <td>
    ...
    <tr>
        <Transition>
            <td colspan="8" v-if="isExpanded" style="background-color:#f0f0f0;border-top:0px solid #000;padding:0;margin:0;">
                <div style="padding:1em;margin:0;background-color: #fcfcfc;">
...
<script>
import detailPasien from '@/Pages/MedicalRecord/MedicalRecordPasien/DetailPasien.vue';
