<template>
    <div class="uk-container uk-container-large" style="padding:1em;">
        <header-page title="SATUSEHAT IHS - ORGANIZATION" subTitle="SatuSehat IHS"></header-page>
        ...
        <div style="margin-top:1em;">
            <div class="uk-card" style="padding:0;margin:0;border-radius:10px;min-height:400px;">
                <ul uk-tab style="padding:0;">
                    <li><a href="#" style="font-size:14px;font-weight:500;">CREATE ORGANIZATION</a></li>
                ...
                <ul class="uk-switcher" style="padding:0;margin:0;">
                    <li>
                        <div style="margin-top:1em;">
                            <base-table ref="tableOrganization"
                                :columns = "tbColumns" 
                                :config="configTable" 
                                :buttons = "buttons"
                                :urlSearch="searchUrl">
    ...
    <form-create-organization ref="formCreateOrganization" v-on:saveSucceed="refreshTable" v-on:closed="refreshTable"></form-create-organization>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                buttons : [
                    { title : 'Data Baru', icon:'plus-circle', 'callback' : this.createOrganization },
                ],
                isLoading : false,
                datas: [],
                genderSelected: 1,
                ...
                tahun: '',
                params: [],
                searchUrl: '/satusehat/organization'
             }
        },
        mounted() {
        },
        ...
        methods : {
            ...mapActions('satusehatOrganisasi',['searchID', 'searchName']),
            ...
            createOrganization(){        
                this.CLR_ERRORS();
                this.$refs.formCreateOrganization.newOrganization();        
            },

            refreshTable() {
                this.$refs.tableOrganization.retrieveData();
            },
        }
    }
    </script>