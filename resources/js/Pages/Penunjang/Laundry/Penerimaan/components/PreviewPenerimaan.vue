<template>
    <div class="uk-modal uk-modal-container" uk-modal="bg-close:false;" id="previewPenerimaanLinen" style="min-height:50vh;">
...
export default {
    ...
    mounted() {},
    methods : {
        ...mapActions('linen',['dataPenerimaanLinen']),
        ...
        previewClosed(){
            ...
            UIkit.modal('#previewPenerimaanLinen').hide();            
        },
            ...
            if(refData) {
                this.dataPenerimaanLinen(refData.linen_terima_id).then((response) => {
                    if (response.success == true) {
                        ...
                        UIkit.modal('#previewPenerimaanLinen').show();
                    }
