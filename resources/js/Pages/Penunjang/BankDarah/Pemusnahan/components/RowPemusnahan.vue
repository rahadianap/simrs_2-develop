    ...
    <tr v-if="rowData" style="border-top:1px solid #ccc;">
        ...
        <td style="width:200px;">
            <div class="uk-inline" style="margin:0;padding:0;">
                <a href="#" class="row-link-menu">{{rowData.darah_musnah_id}}</a>
        ...
        <td style="width:120px;" class="">
            <p style="margin:0;padding:0;">{{rowData.tgl_pemusnahan}} {{rowData.jam_pemusnahan}}</p>
        </td>        
        <td class="uk-text-uppercase">
            <p style="margin:0;padding:0;">{{rowData.catatan}}</p>
        </td>
        <td class="uk-text-uppercase">
            <p style="margin:0;padding:0;">{{rowData.pembuat}}</p>
        </td>
                ...
                <div style="padding:0;margin:0;">
                    ...
                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0 0 0 0;">
                        <thead>
                            ...
                            <th class="child-table-header" style="width:100px; text-align:center;padding:1em;">GOL / RHESUS</th>
                            ...
                            <th class="child-table-header" style="width:80px; text-align:center;padding:1em;">DIMUSNAHKAN</th>
                        </thead>
                        <tbody>
                            <tr v-for="child in rowData.items">
                                <td style="width: auto;">{{child.no_labu}}</td>
                                <td style="text-align:left;">{{child.group_darah}}</td>
                                <td style="width: 100px; text-align:center;">{{child.gol_darah}} / {{child.rhesus}}</td>
                                <td style="width: 60px; text-align:center;">{{child.volume}} CC</td>
                                ...
                                <td style="width: 80px; text-align:center;">
                                    <input class="uk-checkbox" type="checkbox" disabled v-model="child.is_musnah" style="margin-left:5px;border:1px solid black;">
                                </td>
                            </tr>
                        </tbody>
                    </table>
