                    ...
                    <table class="uk-table uk-table-striped hims-picker-table uk-table-responsive">
                        ...
                        <tbody>
                            <tr v-if="listItems && listItems.length > 0" v-for="item in listItems">
                                ...
                                <td><button @click.prevent="proceedFunction(item)"><span uk-icon="check"></span> pilih bed</button></td>
                            </tr>
                            <tr v-else>
...
export default {
    ...
    components : {
        TablePicker,ListPicker,RoomPickerPagination
    },
    data() {
        return {
            params : {
