<template>
    <tr v-if="rowData" style="border-bottom:1px solid #ccc;"  v-bind:class="rowData.is_aktif != true ? 'inaktif':'' ">
        ...
        <td style="width:140px;padding:1em; font-weight: 500; font-size: 12px; color:black;">{{rowData.item_id}}</td>
        <td style="padding:1em; font-size: 12px; color:black;">{{rowData.item_nama}}</td>
    ...
    <tr>
        <Transition>
            <td colspan="9" v-if="isExpandedReg" style="background-color:#fefefe;border-bottom:1px solid #eee;margin:0;padding:0;">
