<template>
    <div class="" style="margin:0;padding:0;">
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid  style="border:none;">                        
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;"> 
                                <div class="uk-width-1-1" style="margin:0;padding:0;">
                                    <!-- <p style="font-size:10px;margin:0;padding:0;">{{ registrasi.reff_trx_id }}</p> -->
                                </div>
        ...
        ></modal-picker>
        <!-- <form-cetakan ref="formCetakan"></form-cetakan> -->
    </div>
...
// import FormCetakan from '@/Pages/Penunjang/Laboratorium/Cetakan/FormCetakan.vue';

export default {
    name : 'form-registrasi-lab',
    components : { 
        SearchSelect,
        SearchList,
        //ModalPickerRuang, 
    ...
    methods : {
        ...
        ...mapMutations('asuransi',['CLR_ASURANSI_LISTS']),
        ...
        ambilPenjaminList(){
            ...
            this.listAsuransi({per_page:'ALL',jns_penjamin:this.registrasi.jns_penjamin, is_aktif:true }).then((response) => {
                //console.log(response.data);
                console.log(this.asuransiLists.data);
            });
        },
        ...
        penjaminSelected(data){
            if(data) {
                ...
                // if(this.isUpdate && !this.isLoading) { this.submisiRegLab(); }
            }
        },
        ...
        addPemeriksaan(dataVal){
            ...
            if(dataVal.length < 1) { return false; }
                ...
                addedTindakan.forEach(data => {
                    ...
                    if(!hargaRes)  {
                        unPriceItemFlag = true;
                        unPriceItem = `${unPriceItem} \n${data.tindakan_nama}`;
                        // alert('Harga tindakan tidak ditemukan.');
                        return false;
                    }
                ...
                if(unPriceItemFlag) {
                    alert(`Harga tidak ditemukan di pemeriksaan : \n${unPriceItem.toUpperCase()}. \n\ndata tidak dapat ditambahkan.`)
                }
