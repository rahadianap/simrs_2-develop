<template>
    <tr v-if="rowData" style="border-top:1px solid #eee;">
        ...
        <td style="width:50px;text-align: center;">
            <input class="uk-checkbox" type="checkbox" v-model="rowData.is_paket" disabled style="margin-left:5px;border:1px solid black;">
        </td>
        <td style="width:50px;text-align: center;">
            <input class="uk-checkbox" type="checkbox" v-model="rowData.is_aktif" disabled style="margin-left:5px;border:1px solid black;">
        </td>
        <td style="width:50px;text-align: center;">
            <p style="margin:0;padding:0;">{{dateFormatting(rowData.created_at)}}</p>
        </td>
    </tr>
    <tr>
        <Transition>
