            ...
            <form action="" @submit.prevent="submitTindakan" style="padding:0;" >
                ...
                <div class="uk-grid-small hims-form-subpage" uk-grid >
                    ...
                    <div class="uk-width-3-4@s uk-grid-small" uk-grid>
                        ...
                        <div class="uk-width-1-2@m" style="margin:0;padding:0.5em 0.2em 0.2em 1.2em;">
                            <div class="uk-form-controls">
                                <label style="color:black; font-size:12px; font-weight: 500;">
                                    <input class="uk-checkbox" type="checkbox" v-model="tindakan.is_paket" disabled>  Paket Pemeriksaan                                    
                                    <span style="font-size:12px; font-weight: 200; color:black; padding:0.2em 0.2em 0.2em 0.2em; margin:0;">
                                        Pemeriksaan memiliki sub pemeriksaan (hasil)
                                    </span>                                 
                                </label>
                            </div>
                        </div>
                ...
                <div v-if="isUpdate">
                    ...
                    <ul class="uk-switcher" style="padding:0;margin:0;">
                        <li>
                            <sub-form-item-lab ref="subFormItemLab" 
                                :tindakan="tindakan" 
                                v-on:updateItemLab="refreshDataTindakan">
                            </sub-form-item-lab>
                        </li>
                        <li>
...
import SubFormUnit from '@/Pages/Penunjang/Laboratorium/MasterPemeriksaan/FormTindakanLab/SubFormUnit.vue';
import SubFormBhp from '@/Pages/Penunjang/Laboratorium/MasterPemeriksaan/FormTindakanLab/SubFormBhp.vue';
import SubFormItemLab from '@/Pages/Penunjang/Laboratorium/MasterPemeriksaan/FormTindakanLab/SubFormItemLab.vue';
...
export default {
    ...
    methods : {
        //...mapActions('tindakanLab',['createTindakan','updateTindakan','dataTindakanLab']),
        ...mapActions('tindakanLab',['dataTindakanLab']),
        ...mapActions('tindakan',['createTindakan','updateTindakan']),
        ...
        klasifikasiChange(){
            ...
            if(this.tindakan.klasifikasi == 'LABORATORIUM') { this.tindakan.is_lab_hasil = true; }
        ...
        retrieveTindakan(id){
            this.isLoading = true;                    
            this.dataTindakanLab(id).then((response)=>{
                if (response.success == true) {
                    this.fillTindakan(response.data);
                    this.isLoading = false;  
                } else {
        ...
        clearTindakan(){
            ...
            this.tindakan.klasifikasi = 'LABORATORIUM';
