<template>
    <div class="uk-modal-container" uk-modal="bg-close:false;" id="modalEditHasilLab" style="min-height:50vh;">
        <div class="uk-modal-dialog uk-modal-body">
            <button class="uk-modal-close-default" type="button" uk-close @click.prevent="modalEditHasilLabClosed"></button>
                ...
                <form action="" @submit.prevent="submitItemLab" style="padding:0;" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid >
                        ...
                        <div class="uk-width-auto" style="text-align:right;padding:0.5em;">
                            <button type="button" @click.prevent="modalEditHasilLabClosed" class="uk-button-close uk-button uk-button-default uk-button-medium" style="font-size:12px;">Tutup</button>                  
                        </div>
                    ...
                    <div class="uk-grid-small hims-form-subpage" uk-grid >
                        <div class="uk-width-1-4@s" style="padding:0 0.5em 1em 0.5em;">
                            ...
                            <p style="font-size:12px;font-style:italic;padding:0;margin:0;">
                                informasi utama terkait item hasil.
                            </p>
                        </div>
                        <div class="uk-width-3-4@s uk-grid-small" uk-grid>
                            <div class="uk-width-3-4@m">
                                ...
                                <div class="uk-form-controls">
                                    <input class="uk-input uk-form-small" v-model="itemLab.hasil_nama" type="text" placeholder="nama item pemeriksaan" required style="color:black;">
                                </div>
                            </div>
                        ...
                        <div style="margin:0;padding:0;" class="uk-overflow-auto">
                            <table class="uk-table hims-table uk-table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr v-if="!isFormShow">
                                        <td colspan="5"><a href="#" @click.prevent="toggleFormNormal">tambahkan nilai normal</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div v-if="isFormShow" style="border-top:1px solid #cc0202;">
                                    ...
                                    <div class="uk-grid-small uk-width-full" uk-grid style="margin:0;padding:1em;">                                    
                                        <div class="uk-width-1-1@m uk-grid-small" uk-grid  style="padding:0;margin:0;">
                                            <div class="uk-width-1-2@m">
                                                ...
                                                <div class="uk-form-controls">
                                                    <select v-model="addedNormal.normal_group" class="uk-form-small uk-select" style="width:100%;">
                                            ...
                                            <div class="uk-width-1-4@m">
                                                ...
                                                <div class="uk-form-controls">
                                                    <select v-model="addedNormal.jenis_hasil" class="uk-form-small uk-select" style="width:100%;">
                                        ...
                                        <div class="uk-width-1-1@m" style="padding:1em 0 0 0;margin:0.5em 0 0 0;text-align:right;">
                                            <button type="button" class="uk-button-small" style="line-height: 20px; margin-right:5px;" @click.prevent="toggleFormNormal">Tutup</button>
...
export default {
    ...
    methods : {
        ...
        modalEditHasilLabClosed(){
            this.clearItemLab();
            this.$emit('modalEditHasilLabClosed',true);
            UIkit.modal('#modalEditHasilLab').hide();
        },
        ...
        showModal(data) {         
            ...
            UIkit.modal('#modalEditHasilLab').show(); 
        },
