<template>
    <div class="uk-modal uk-modal-container" uk-modal="bg-close:false;" id="modalDistCssd" style="min-height:50vh;">
                    ...
                    <div class="uk-grid-small hims-form-subpage" uk-grid  style="border:none;">
                        <div class="uk-width-1-4@m" style="padding:0 0.5em 1em 0.5em;">
                            ...
                            <p style="font-size:12px;font-style:italic;padding:0;margin:0;">
                                detail data pengiriman ke unit-unit.
                            </p>
                        </div>
                        <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                            <div class="uk-grid-small uk-width-3-4@l 1-1@m" uk-grid> 
                                <div class="uk-width-1-1">
                                    <h5 style="font-weight:500;">{{pengiriman.cssd_dist_id}}</h5>
                                </div>
                                ...
                                <table class="uk-table hims-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align:center;width:100px;padding:0.2em;margin:0;">
                                                <input class="uk-input uk-form-small" type="number" v-model="cssdItem.jml_keluar" min="0" style="text-align: center;">
                                            </td>
...
export default {
    ...
    methods : {
        ...
        modalClosed(){
            ...
            this.$emit('modalDistCssdClosed',data);
            UIkit.modal('#modalDistCssd').hide();            
        },
        ...
        newData(){
            ...
            this.clearCssdItem();
            this.isUpdate = false;
            this.formTitle = "DATA BARU PENGIRIMAN";
            UIkit.modal('#modalDistCssd').show();
        },
        ...
        editData(refData) {
            ...
            this.clearPengiriman();
            this.clearCssdItem();
            this.formTitle = "UBAH DATA PENGIRIMAN";
            this.isUpdate = true;
            this.isLoading = true;

            if(refData) {
                this.dataPengirimanCssd(refData.cssd_dist_id).then((response) => {
