<template>
    <div class="uk-modal uk-modal-container" uk-modal="bg-close:false;" id="previewPengirimanCssd" style="min-height:50vh;">
            ...
            <div class="hims-form-container" style="padding:0 1.5em 2em 1.5em; margin:0;">
                <div>
                    <table>
                        <tbody>
                            <tr>
                                <td colspan="3" style="font-weight:500; font-size:16px; padding:1em 0 1em 0.5em; color:black;">{{pengiriman.cssd_dist_id}}</td>
                            </tr>
...
export default {
    ...
    mounted() {},
    methods : {
        ...mapActions('cssd',['dataPengirimanCssd']),
        ...
        previewClosed(){
            ...
            UIkit.modal('#previewPengirimanCssd').hide();            
        },
            ...
            if(refData) {
                this.dataPengirimanCssd(refData.cssd_dist_id).then((response) => {
                    if (response.success == true) {
                        ...
                        UIkit.modal('#previewPengirimanCssd').show();
                    }
