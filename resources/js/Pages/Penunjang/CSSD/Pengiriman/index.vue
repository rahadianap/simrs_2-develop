<template>
    <div class="uk-container uk-container-xlarge" style="padding:1em;margin:0;">    
        <header-page title="DISTRIBUSI CSSD" subTitle="daftar distribusi item steril"></header-page>
        ...
        <modal-pengiriman ref="modalPengirimanCssd" v-on:modalDistCssdClosed="refreshTable"></modal-pengiriman>
        <preview-pengiriman ref="previewPengirimanCssd"></preview-pengiriman>
    </div>
</template>
<script>
...
import ModalPengiriman from '@/Pages/Penunjang/CSSD/Pengiriman/components/ModalPengiriman.vue';
import PreviewPengiriman from '@/Pages/Penunjang/CSSD/Pengiriman/components/PreviewPengiriman.vue';
import RowPengiriman from '@/Pages/Penunjang/CSSD/Pengiriman/components/RowPengiriman.vue';
...
export default {
    ...
    data() {
        return {
            ...
            tbColumns : [
                { name : 'cssd_dist_id', title : 'ID', colType : 'text', },
    ...
    methods : {
        ...
        preparedData(){
            if(this.searchUrl == null || this.searchUrl == '' ) {
                this.searchUrl = '/sterilizations/distributions';
            } 
        },

        addData(){
            this.$refs.modalPengirimanCssd.newData();
        },

        updateData(data) {
            if(data){ this.$refs.modalPengirimanCssd.editData(data); }
        },
        ...
        previewData(data) {
            this.$refs.previewPengirimanCssd.previewData(data);
        },
