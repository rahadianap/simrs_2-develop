<template>
    <div class="uk-modal" uk-modal="bg-close:false;" id="modalHasilRad" style="min-height:50vh;">
                        ...
                        <div class="uk-width-1-1@m">
                            <div class="uk-form-controls">
                                <search-select
                                    ...
                                    captionField = "rad_template_nama"
                                    valueField = "rad_template_nama"
                                    :itemListData = radTemplateDesc
                                    :value = "radTemplateSelected"
...
export default {
    ...
    data() {
        return {
            ...
            radTemplateDesc : [
                { colName : 'rad_template_nama', labelData : '', isTitle : true },
                { colName : 'rad_template_id', labelData : '', isTitle : false },
            ],

            radTemplateSelected : null,
            pemeriksaan : {
                detail_id : null,
                reg_id : null,
                trx_id : null,
    ...
    methods : {        
        ...
        modalHasilRadClosed(){
            ...
            this.$emit('modalHasilRadClosed',true);
            UIkit.modal('#modalHasilRad').hide();
        },
        ...
        showModal(data) { 
            ...
            if(data){
                ...
                UIkit.modal('#modalHasilRad').show(); 
            }
        },

        templateSelected(data) {
            if(data) {
                this.radTemplateSelected = data.rad_template_nama;
                this.pemeriksaan.uraian_hasil  = data.uraian;
        ...
        submitHasilRad(){            
            this.CLR_ERRORS();
            this.$emit('hasilRadUpdated',this.pemeriksaan);
            UIkit.modal('#modalHasilRad').hide();
