        ...
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="hims-form-container" style="padding:0; ">
                <form action="" @submit.prevent="submitPemeriksaanLab">                        
                    <h3 class="uk-text-uppercase" style="font-weight:bold;">Pemeriksaan Radiologi</h3>
                    <div class="uk-grid-small" uk-grid>
                        ...
                        <div class="uk-width-1-2@m" style="margin:0;padding:1em 0.2em 0.2em 1.2em;">
                            <div class="uk-form-controls">
                                <label style="color:black; font-size:12px; font-weight: 500;">
                                    <input class="uk-checkbox" type="checkbox" v-model="pemeriksaan.is_tampilkan_dokter"> Tampilkan Dokter                                    
                                </label>
                                <p style="font-size:12px; font-weight: 200; color:black; padding:0.2em 0.2em 0.2em 1.6em; margin:0;">
                                    tampilkan nama dokter di pemeriksaan
                                </p> 
                            </div>
                        </div>
...
export default {
    name : 'modal-new-pemeriksaan-rad',
    ...
    methods : {
        ...
        ...mapActions('tindakan',['createTindakan']),
        ...
        clearPemeriksaan(){
            ...
            this.pemeriksaan.klasifikasi = 'RADIOLOGI';
        ...
        submitPemeriksaanLab(){            
            this.CLR_ERRORS();
            if(confirm(`Simpan pemeriksaan radiologi ini ?`)){
                this.createTindakan(this.pemeriksaan).then((response) => {
                    if (response.success == true) {
                        alert(response.message);
                        this.clearPemeriksaan();
                        UIkit.modal('#modalNewPemeriksaanLab').hide();
                        this.$emit('addPemeriksaanRadSuccess',response.data);
