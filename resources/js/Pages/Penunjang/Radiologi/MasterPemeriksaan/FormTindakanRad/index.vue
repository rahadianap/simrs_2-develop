                ...
                <ul class="uk-breadcrumb" style="padding:0;margin:0;">
                    <li>
                        <a href="#" @click.prevent="closeModalTindakanLab" class="uk-text-uppercase">
                            <h4 style="font-weight:500;margin:0;padding:0;display: inline-block;" class="uk-text-uppercase">PEMERIKSAAN RADIOLOGI</h4>
                        </a>
                    </li>
...
import SubFormUnit from '@/Pages/Penunjang/Radiologi/MasterPemeriksaan/FormTindakanRad/SubFormUnit.vue';
import SubFormBhp from '@/Pages/Penunjang/Radiologi/MasterPemeriksaan/FormTindakanRad/SubFormBhp.vue';

export default {
    name : 'form-tindakan-rad', 
    components : { 
        SearchList,
        SubFormUnit,
        SubFormBhp,
    ...
    methods : {
        ...
        clearTindakan(){
            ...
            this.tindakan.klasifikasi = 'RADIOLOGI';
