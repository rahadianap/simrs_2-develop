<template>
        ...
        <td>
            <div style="margin:0;padding:0;">
                <a href="#" @click.prevent="linkCallback(rowData)" class="row-link-menu">
                    {{rowData.trx_id}}
                    <p style="margin:0;padding:0;font-weight:350;">{{rowData.tgl_permintaan}}</p>
                </a>
            </div>      
        </td>
        <td class="uk-text-uppercase">
            <p style="margin:0;padding:0;font-weight: 500;">{{rowData.tgl_periksa}} {{rowData.jam_periksa}}</p>
    ...
    <tr>
        <Transition>
            <td colspan="10" v-if="isExpanded" style="background-color:#fefefe;border-bottom:1px solid #eee;">
