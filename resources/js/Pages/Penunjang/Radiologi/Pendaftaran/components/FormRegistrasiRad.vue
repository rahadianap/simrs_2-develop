                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <!-- <select v-model="registrasi.unit_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;color:black;"> 
                                ...
                                <!-- <div class="uk-width-1-4@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tgl Transaksi*</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="registrasi.tgl_transaksi" type="date" style="color:black;" disabled>
                                    </div>
                                </div>
                                <div class="uk-width-1-4@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Jam Transaksi*</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="registrasi.jam_transaksi" type="time" style="color:black;" disabled>
                                    </div>
                                </div> -->
                            </div>
                        </div>                                
...
export default {
    ...
    methods : {
        ...
        modalClosed(){
            ...
            this.isUpdate = false;
            this.$emit('registrasiRadClosed',true);
        },
