    ...
    <div class="uk-container uk-container-large" style="padding:1em;">
        ...
        <ul class="uk-switcher" style="padding:0;margin:0;">
            <li style="padding:0;margin:0;">
                <div>
                    <header-page 
                        title="MASTER PEMERIKSAAN PATOLOGI" 
                        subTitle="master data pemeriksaan patologi">
                    </header-page>
        ...
        <div>
            <modal-new-pemeriksaan-pa 
                ref="modalNewPemeriksaanPa" 
                v-on:addPemeriksaanPaSuccess="updatePemeriksaan">
            </modal-new-pemeriksaan-pa>
        </div>
...
import RowListTindakanPa from "@/Pages/Penunjang/Patologi/MasterPemeriksaan/components/RowListTindakanPa.vue";

import FormTindakanPa from '@/Pages/Penunjang/Patologi/MasterPemeriksaan/FormTindakanPa';
import ModalNewPemeriksaanPa from '@/Pages/Penunjang/Patologi/MasterPemeriksaan/components/ModalNewPemeriksaanPa.vue';

export default {
    components : {
        FormTindakanPa,
        ModalNewPemeriksaanPa,
        headerPage,
        BaseTable,
        RowListTindakanPa
    },
    data() {
        return {
            ...
            searchUrl : '/patologi/inspections',
            dataLists : null,
        }
    },
    computed : {
    ...
    methods : {
        ...
        addTindakan(){        
            this.CLR_ERRORS();
            this.$refs.modalNewPemeriksaanPa.showModal();     
        },
        updatePemeriksaan(data){        
            this.CLR_ERRORS();
            this.$refs.formTindakanPa.editTindakan(data.tindakan_id); 
