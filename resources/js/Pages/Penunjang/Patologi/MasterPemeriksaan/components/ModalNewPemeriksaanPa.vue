        ...
        <div class="uk-modal-dialog uk-modal-body">
            ...
            <div class="hims-form-container" style="padding:0; ">
                <form action="" @submit.prevent="submitPemeriksaanLab">                        
                    <h3 class="uk-text-uppercase" style="font-weight:bold;">Pemeriksaan Patologi</h3>
...
export default {
    ...
    methods : {
        ...
        clearPemeriksaan(){
            ...
            this.pemeriksaan.klasifikasi = 'PATOLOGI';
        ...
        submitPemeriksaanLab(){            
            this.CLR_ERRORS();
            if(confirm(`Simpan pemeriksaan patologi ini ?`)){
                this.createTindakan(this.pemeriksaan).then((response) => {
                    if (response.success == true) {
                        alert(response.message);
                        this.clearPemeriksaan();
                        UIkit.modal('#modalNewPemeriksaanLab').hide();
                        this.$emit('addPemeriksaanPaSuccess',response.data);
