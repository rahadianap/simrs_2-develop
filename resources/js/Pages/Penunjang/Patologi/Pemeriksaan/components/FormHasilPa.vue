                            ...
                            <div class="uk-grid-small hims-form-subpage" uk-grid>
                                ...
                                <div class="uk-width-1-1@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                    <table class="uk-table uk-table-striped child-table tb-hasil-lab" style="padding:0;margin:0;">
                                        ...
                                        <tbody> 
                                            <tr v-if="registrasi.hasil" v-for="res in registrasi.hasil">
                                                <td >
                                                    <p style="margin:0;padding:0;font-weight: 500;">
                                                        <span style="font-weight:500;">{{res.tindakan_id}}</span> {{res.tindakan_nama}}
                                                    </p>
                                                </td>
                                                <td style="text-align:left;">
                                                    <p style="margin:0;padding:0;font-weight: 500;">{{res.hasil}}</p>
                                                </td>
                                                <td style="text-align:left;">{{res.catatan}}</td>                                       
                                                <td style="text-align:left;">
                                                    <p style="margin:0;padding:0;">{{res.dokter_nama}}</p>
                                                </td>  
...
export default {
    ...
    methods : {
        ...
        ...mapActions('patologi',['createPatologi','deletePatologi','updatePatologi','updateHasilPatologi','dataPatologi','confirmPatologi',
                'unConfirmPatologi', 'dataHasilPatologi'
            ]),
