                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <label style="font-size: 14px; margin-right: 10px;"><input class="uk-paio" type="radio" v-model="registrasi.is_multi_hasil" value=true> Multi hasil</label>
                                        <label style="font-size: 14px;"><input class="uk-paio" type="radio" v-model="registrasi.is_multi_hasil" value=false> Hasil tunggal</label>
                                    </div>
                                </div>
                            </div>
                        </div>          
...
export default {
    ...
    methods : {
        ...
        ...mapActions('patologi',['dataPatologi','createPatologi','updatePatologi','deletePatologi','confirmPatologi']),
            ...
            if(refData) {
                this.dataPatologi(refData.trx_id).then((response) => {
                    if (response.success == true) {
                        ...
                        alert('data registrasi patologi tidak ditemukan'); 
                        this.isLoading = false; 
                    }
                })
            }
