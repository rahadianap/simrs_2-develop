<template>
    <div class="uk-modal-container" id="modalViewRegistrasiPa" uk-modal>
        <div class="uk-modal-dialog uk-modal-body">
            <button class="uk-modal-close-default" type="button" uk-close></button>
            <h4 style="font-weight:500;padding:0;margin:0;">{{registrasi.reff_trx_id}}</h4>
                    ...
                    <div class="hims-form-container view-lab-container" style="padding:0 1.5em 2em 1.5em; margin:0;">     
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                <div class="uk-width-1-1@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <textarea class="uk-textarea uk-form-small" v-model="registrasi.diag_klinis" type="text" style="color:black;" disabled></textarea>
                                    </div>
                                </div>
                                <!-- <div class="uk-width-1-2@m">
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            <div class="uk-width-1-4@m" style="padding:0 0.5em 1em 0.5em;">
                                ...
                                <p style="font-size:12px;font-style:italic;padding:0;margin:0;">
                                    detail data pendaftaran patologi.
                                </p>
                            </div>
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                <div class="uk-width-1-4@m">
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="date" v-model="registrasi.tgl_periksa" style="color:black;"  required>
                                    </div>
                                </div>
                                <div class="uk-width-1-4@m">
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <select v-model = "registrasi.kelas_harga_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;" required :disabled="isLocked" @change="kelasSelected">
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            <div class="uk-width-1-1@m uk-grid-small" uk-grid style="padding:0 0.5em 0 0.5em;">
                                <div class="uk-width-expand@m">
                                    <h5 style="color:indigo;padding:0;margin:0;">PEMERIKSAAN PATOLOGI ANATOMI
                                        <span style="font-size:12px;font-style:italic;padding:0;margin:0 0 0 0.2em;">detail pemeriksaan patologi anatomi.</span>
                                    </h5>
                                </div>                                   
                            </div>
...
export default {
    ...
    methods : {
        ...mapActions('labRegistrasi',['dataRegistrasi','unConfirmRegistrasi']),
        ...mapActions('patologi',['dataPatologi','unConfirmPatologi','confirmPatologi']),
        ...
        modalClosed(){
            ...
            this.isUpdate = false;
            this.$emit('viewRegistrasiPaClosed',true);
            UIkit.modal('#modalViewRegistrasiPa').hide();
        },

        viewData(refData) {
            if(refData) {
                UIkit.modal('#modalViewRegistrasiPa').show();
                this.CLR_ERRORS();
                this.clearRegistrasi();
                this.isUpdate = true;
                this.isLoading = true;
        ...
        fillRegistrasi(data){
            ...
            this.registrasi.tgl_periksa = data.tgl_periksa;//tgl_periksa_split[0];
            this.registrasi.jam_periksa = data.jam_periksa; //tgl_periksa_split[1];
        ...
        konfirmasiReg(){
            this.CLR_ERRORS();
            if(confirm(`Proses ini akan mengubah status data registrasi ${this.registrasi.trx_id} - ${this.registrasi.nama_pasien} dan memulai pengisian data. Lanjutkan ?`)){
                this.isLoading = true;
                this.confirmPatologi(this.registrasi).then((response) => {
                    if (response.success == true) {
                        this.isLoading = false; this.isUpdate = false;
                        alert('data registrasi patologi BERHASIL dikonfirmasi.');                        
                        this.clearRegistrasi();
                        UIkit.modal('#modalViewRegistrasiPa').hide();
                        this.$emit('confirmPaSuccess',response.data);
                    }
                    else { 
                        alert('data registrasi patologi tidak berhasil dikonfirmasi.'); 
                        this.isLoading = false;
                    }
                })
            }
