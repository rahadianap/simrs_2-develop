    ...
    <div class="uk-container uk-container-xlarge" style="padding:1em;">        
        ...
        <ul class="uk-switcher" style="padding:0;margin:0;">
            <li style="padding:0;margin:0;">
                <div>
                    <header-page title="TRANSAKSI PATOLOGI ANATOMI" subTitle="transaksi dan hasil pemeriksaan patologi anatomi"></header-page>
                        ...
                        <base-table ref="tableHasilLab"
                            ...
                            <template v-slot:tbl-body>
                                <tbody v-if="dataLists">
                                    <row-pemeriksaan-pa v-for="dt in dataLists" :rowData="dt" :linkCallback = viewHasilLab></row-pemeriksaan-pa>
                                </tbody>
                            </template>
                        </base-table>
                    </div>
        ...
        <div>
            <view-pemeriksaan-pa ref="viewPemeriksaanPa" 
                ...
                v-on:confirmPaSuccess = "formHasilLabClosed"
...
import ViewPemeriksaanPa from '@/Pages/Penunjang/Patologi/components/ViewPemeriksaanPa.vue';
import FormPemeriksaanPa from '@/Pages/Penunjang/Patologi/components/FormPemeriksaanPa.vue';
import RowPemeriksaanPa from '@/Pages/Penunjang/Patologi/Pemeriksaan/components/RowPemeriksaanPa.vue';
    ...
    data() {
        return {
            ...
            tbColumns : [
                ...
                { name : 'no_spesimen', title : 'No.Spesimen', colType : 'text',},
