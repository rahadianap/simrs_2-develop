<template>
    <tr v-if="rowData" style="border-bottom:1px solid #ccc;">
        ...
        <td class="uk-text-uppercase">
            ...
            <p style="font-size:11px; margin:0;padding:0;">{{rowData.pasien_id}}</p>
        </td>
        <td class="uk-text-uppercase">
        ...
        <td class="uk-text-uppercase">
            <p style="margin:0;padding:0;font-weight: 500;">{{rowData.tgl_permintaan}}</p>
        </td>
        <td class="uk-text-uppercase">
            <p style="font-size:11px; margin:0;padding:0;">{{rowData.tgl_dibutuhkan}}</p>
        </td>
        <td class="uk-text-uppercase">
