<template>
    <div class="uk-modal-container" id="modalRealisasiOps" uk-modal>
        <div class="uk-modal-dialog uk-modal-body">
            <button class="uk-modal-close-default" type="button" uk-close></button>
            <div class="uk-card-default" uk-card style="background-color: #fff;margin-top:0.5em;padding:0.7em;color:black;">
                <h4 style="color:black;font-weight: 500;margin:0;padding:0;">REALISASI OPERASI</h4>
            </div>
                        ...
                        <div class="hims-form-container" style="padding:0 1.5em 2em 1.5em; margin:0;">     
                            ...
                            <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                                <div class="uk-width-1-4@m" style="padding:0 0.5em 0.5em 0.5em;">
                                    <h5 style="color:indigo;padding:0;margin:0;">KELAS DAN RUANG</h5>
                                    <p style="font-size:12px;font-style:italic;padding:0;margin:0;">
                            ...
                            <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                                ...
                                <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">                                  
                                    ...
                                    <div class="uk-width-1-1@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Diag. Pra Operasi</label>
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="text" v-model="registrasi.diagnosa_pra" style="color:black;">
                                        </div>
                                    </div>
...
export default {
    ...
    methods : {
        ...
        refreshRegistrasi(){
            this.CLR_ERRORS();
            this.isLoading = true;
            this.dataOperasi(this.registrasi.trx_id).then((response) => {
                if (response.success == true) {              
                    this.fillRegistrasi(response.data);
                    this.isLoading = false;
                }
        ...
        konfirmasiReg(){
            if(this.registrasi.bed_id == null) {
                alert('data bed tidak boleh kosong');
                return false;
            }

            if(this.registrasi.tindakan_id == null ||this.registrasi.tindakan_id == '' || this.registrasi.tindakan_nama == null || this.registrasi.tindakan_nama == '') {
                alert('data paket tindakan tidak boleh kosong');
                return false;
            }
            
            this.CLR_ERRORS();
            if(confirm(`Proses ini akan Mengubah status data operasi ${this.registrasi.trx_id} - ${this.registrasi.nama_pasien}. Pastikan pemilihan bed, kelas pelayanan, dan paket operasi sudah sesuai. Lanjutkan ?`)){
                this.isLoading = true;
                this.confirmOperasi(this.registrasi).then((response) => {
                    if (response.success == true) {
                        this.isLoading = false; 
