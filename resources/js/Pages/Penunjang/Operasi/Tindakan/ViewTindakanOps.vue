<template>
    <div class="uk-modal-container" id="modalViewTindakanOps" uk-modal>
        <div class="uk-modal-dialog uk-modal-body">
            <button class="uk-modal-close-default" type="button" uk-close></button>
            <div style="margin:0;padding:0;">
                <form action="" @submit.prevent="konfirmasiReg" style="margin:0;padding:0;">
                    <div style="margin:0;padding:0.5em;text-align: center;">
                        <h4 style="font-weight:500;padding:0;margin:0;">{{registrasi.trx_id}}</h4>
                        <p style="font-size:12px;color:#333;padding:0;margin:0;"><span>Reg. </span>{{registrasi.reg_id}}</p>
                    </div>
                        ...
                        <div class="uk-grid-small uk-card1 uk-card-default1 hims-form-header" uk-grid style="padding:0;margin:0;">                        
                            <div class="uk-width-1-1" style="margin:0 0 0.5em 0;padding:0.5em 0 0 0.5em;">
                                <div class="uk-grid-small uk-box-shadow-large" uk-grid style="border-radius:5px;padding:0;">
                                    ...
                                    <button :disabled="isLoading" type="submit" class="hims-table-btn uk-width-auto" style="padding:0.5em;"><span uk-icon="file-text"></span> Realisasi</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;"> 
                                    ...
                                    <div class="uk-width-1-2@m">
                                        ...
                                        <div class="uk-inline uk-width-1-1">
                                            <input class="uk-input uk-form-small" v-model="registrasi.nama_pasien" type="text" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="text" v-model="registrasi.no_rm" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-4@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">ID Pasien</label>
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="text" v-model="registrasi.pasien_id" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-4@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Jenis Kelamin</label>
                                        <div class="uk-form-controls">
                                            <select v-model="registrasi.jns_kelamin" class="uk-select uk-form-small" required style="color:black;" disabled>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="text" v-model="registrasi.tempat_lahir" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-4@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tgl Lahir</label>
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="date" v-model="registrasi.tgl_lahir" style="color:black;" :max="minDate" disabled required>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-4@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Jenis Penjamin</label>
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="text" v-model="registrasi.jns_penjamin" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-2@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Nama Penjamin</label>
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="text" v-model="registrasi.penjamin_nama" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-4@m">
                            ...
                            <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                                ...
                                <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <select v-model = "registrasi.kelas_harga" class="uk-select uk-form-small" style="border:1px solid #cc0202; color:black;" disabled required>
                                    ...
                                    <div class="uk-width-1-2@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" v-model="registrasi.unit_nama" type="text" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" v-model="registrasi.ruang_nama" type="text" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" v-model="registrasi.no_bed" type="text" style="color:black;" readonly required>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="text" v-model="registrasi.skala_operasi" style="color:black;" req>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-2@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tindakan Operasi*</label>
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="text" v-model="registrasi.tindakan_nama" style="color:black;" required>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-2@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Diag. Pra Operasi*</label>
                                        <div class="uk-form-controls">
                                            <textarea class="uk-textarea uk-form-small" type="text" v-model="registrasi.diagnosa_pra" style="color:black;" required></textarea>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-2@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Diag. Pasca Operasi</label>
                                        <div class="uk-form-controls">
                                            <textarea class="uk-textarea uk-form-small" type="text" v-model="registrasi.diagnosa_pasca" style="color:black;" disabled></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                                ...
                                <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="date" v-model="registrasi.tgl_operasi" style="color:black;" :min="minDate" disabled required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="time" v-model="registrasi.jam_operasi" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="date" v-model="registrasi.tgl_selesai" style="color:black;" :min="minDate" disabled required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="time" v-model="registrasi.jam_selesai" style="color:black;" disabled required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="date" v-model="registrasi.tgl_anestesi" style="color:black;" :min="minDate" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-width-1-4@m">
                                        ...
                                        <div class="uk-form-controls">
                                            <input class="uk-input uk-form-small" type="time" v-model="registrasi.jam_anestesi" style="color:black;" disabled>
                                        </div>
                                    </div>
                                    <!-- <div class="uk-width-1-4@m">
                                        <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Jenis Tindakan</label>
                                ...
                                <div class="uk-width-1-1@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0;">
                                        <thead>
                                            ...
                                            <th class="tb-header-reg" style="text-align:left;color:white;">Posisi</th>  
                                        ...
                                        <tbody>                                               
                                            <tr v-for="row in registrasi.tim_operasi">
                                                ...
                                                <td style="width:200px;font-size:12px;color:black;padding:0.2em;margin:0;">{{row.posisi}}</td>
...
export default {
    ...
    methods : {
        ...mapActions('operasi',['dataOperasi','confirmOperasi']),
        ...
        modalClosed(){
            ...
            UIkit.modal('#modalViewTindakanOps').hide();
        },
                ...
                if(refData) {
                    this.dataOperasi(refData.trx_id).then((response) => {
                        if (response.success == true) {
                            ...
                            UIkit.modal('#modalViewTindakanOps').show();
                        }
                        else { 
        ...
        clearRegistrasi() {
            ...
            this.registrasi.tgl_operasi = this.getTodayDate();
            this.registrasi.jam_operasi = this.getTimeNow();
            
            this.registrasi.tgl_selesai = this.getTodayDate();
            this.registrasi.jam_selesai = this.getTimeNow();
            
            this.registrasi.tgl_anestesi = null;
            this.registrasi.jam_anestesi = null;
        ...
        fillRegistrasi(data){
            ...
            this.registrasi.tgl_selesai = data.tgl_selesai;
            this.registrasi.jam_selesai = data.jam_selesai;
            
            this.registrasi.tgl_anestesi = data.tgl_anestesi;
            this.registrasi.jam_anestesi = data.jam_anestesi;
        ...
        konfirmasiReg(){
            this.CLR_ERRORS();
            if(confirm(`Proses ini akan Mengubah status data ${this.registrasi.trx_id} - ${this.registrasi.nama_pasien}. Lanjutkan ?`)){
                this.isLoading = true;
