<template>
    <div class="uk-modal-container" id="modalRegistrasiOps" uk-modal>
        <div class="uk-modal-dialog uk-modal-body">
            <button class="uk-modal-close-default" type="button" uk-close></button>
            <div class="uk-card-default" style="background-color: #fff;margin-top:0.5em;padding:0.7em;color:black;">
                <h4 style="color:black;font-weight: 500;margin:0;padding:0;">JADWAL OPERASI</h4>
            </div>
...
export default {
    ...
    methods : {
        ...
        modalClosed(){
            ...
            UIkit.modal('#modalRegistrasiOps').hide();
        },
        ...
        editData(refData) {
            ...
            if(refData) {
                this.dataOperasi(refData.trx_id).then((response) => {
                    if (response.success == true) {                                  
                        UIkit.modal('#modalRegistrasiOps').show();
