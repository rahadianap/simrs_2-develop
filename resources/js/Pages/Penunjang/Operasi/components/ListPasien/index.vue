        ...
        <div class="uk-width-1-1 uk-grid-small" uk-grid>
            ...
            <div class="uk-width-auto@m">
                <div class="uk-button-group uk-box-shadow-large" style="padding:0;margin:0;border-radius:5px;">                
                    <button class="hims-table-btn" @click.prevent="addPasien">
        ...
        <template v-if="asalPasien == 'MASTER PASIEN'">
            <div class="uk-width-1-1" style="margin:0.5em 0 0 0;padding:0 1em 0.5em 1em;">
                <base-table ref="tableMasterPasien"
                    ...
                    :urlSearch="urlPasienSearch" v-on:updateListDataTable="updateListData">
        ...
        <template v-else>
            <div class="uk-width-1-1" style="margin:0.5em 0 0 0;padding:0 1em 0.5em 1em;">
                <base-table ref="tablePasienPoli"
                    ...
                    :config = "configPoliTable" 
                    :urlSearch="urlPoliSearch" 
                    v-on:updateListDataTable="updateListDataPoli">
                    <template v-slot:tbl-body>
                        <tbody v-if="pasienPoliLists">
                            <row-pasien-poli v-for="dt in pasienPoliLists" :rowData="dt" :linkCallback = "pasienPoliSelected"></row-pasien-poli>
                        </tbody>
                    </template>
                </base-table>
            </div>
...
import RowPasien from '@/Pages/Penunjang/Operasi/components/ListPasien/RowPasien.vue';
import RowPasienInap from '@/Pages/Penunjang/Operasi/components/ListPasien/RowPasienInap.vue';
import RowPasienPoli from '@/Pages/Penunjang/Operasi/components/ListPasien/RowPasienPoli.vue';
import ModalFormPasien from '@/Pages/Penunjang/Operasi/components/ListPasien/ModalFormPasien.vue';

export default {
    name :'list-pasien',
    components : { BaseTable,RowPasien,ModalFormPasien, RowPasienInap, RowPasienPoli },
    data() {
        return {
            isUpdate : false,
            isLoading : true,
            ...
            /**list pasien poli */
            configPoliTable : { isExpandable : true, filterType : 'SIMPLE', },
            tbPoliColumns : [
    ...
    methods : {
        ...
        showMasterPasien(){
            ...
            this.urlPasienSearch = '/patients';
        },

        showPasienInap(){
            this.pasienInapLists = null;
            this.asalPasien = 'PASIEN INAP';
            this.urlInapSearch = '/inpatients/admissions?status=RAWAT';
        },

        showPasienPoli(){
            this.pasienLists = null;
            this.asalPasien = 'PASIEN POLI / IGD';
            this.urlPoliSearch = '/registrations';
        },
        ...
        pasienPoliSelected(data) {
            if(data) {
                this.$emit('pasienPoliSelected',data);
            }
        },
        refreshPasien(){
