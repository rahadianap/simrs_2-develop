<template>
    <div class="uk-modal uk-modal-container" uk-modal="bg-close:false;" :id="modalId" style="min-height:50vh;">
        <div class="uk-modal-dialog uk-modal-body">
            <h2 class="uk-modal-title">Registrasi Rawat Jalan</h2>
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">      
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="date" v-model="registrasi.tgl_periksa" style="color:black;" required :min="minDate" @change="getTodayUnit">
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-1@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <select v-model="registrasi.jadwal_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;color:black;" @change="dpjpSelected"> 
...
export default {
    ...
    methods : {
        ...
        ...mapActions('pendaftaran',['createRegistrasi','dataRegistrasi','updateRegistrasi','listUnitToday']),
        ...
        modeRegChange(){
            if (this.registrasi.mode_reg == 'WALK IN') {
        ...
        editData(refData) {
            ...
            this.isLoading = true;
            if(refData) {
                this.dataRegistrasi(refData.reg_id).then((response) => {
                    if (response.success == true) {
        ...
        refreshPasien(data){
            ...
            UIkit.switcher('#switcherFormAdmisiPoli').show(1);
        },
