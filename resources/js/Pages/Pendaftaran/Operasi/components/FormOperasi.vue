                    ...
                    <div class="uk-grid-small hims-form-subpage" uk-grid>
                        ...
                        <div class="uk-width-3-4@m uk-grid-small" uk-grid style="padding:0 0.5em 0.2em 0.5em;">         
                            ...
                            <div class="uk-width-3-4@m">
                                ...
                                <div class="uk-form-controls">
                                    <input class="uk-input uk-form-small" v-model="distribusi.depo_penerima" type="text" style="color:black;">
                                </div>
                            </div>
...
export default {
    ...
    methods : {
        ...
        //     this.registrasi.is_pasien_luar = null;
        ...
        //     this.registrasi.pasien.is_hamil = null;
        //     this.registrasi.pasien.is_pasien_baru = null;
