<template>
    <div class="" style="margin:0;padding:0;">
        <ul class="uk-tab hims-penunjang-tab" uk-switcher id="switcherFormRegPenunjang" style="padding:0;margin:0;">
...
import ListPasien from '@/Pages/Pendaftaran/Penunjang/components/ListPasien';

export default {
    name : 'form-registrasi-penunjang',
    ...
    methods : {
        ...
        newData(){
            ...
            this.isUpdate = false;
            this.clearRegistrasi();
            UIkit.switcher('#switcherFormRegPenunjang').show(0);
        ...
        refreshPasien(data){
            ...
            // UIkit.switcher('#switcherFormRegPenunjang').show(1);
        },

        refreshPasienInap(data) {
            alert('refresh pasien inap');
            UIkit.switcher('#switcherFormRegPenunjang').show(1);
        },

        refreshPasienPoli(data){
            alert('refresh pasien poli');
            UIkit.switcher('#switcherFormRegPenunjang').show(1);
        },
