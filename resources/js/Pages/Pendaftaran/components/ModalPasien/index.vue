                ...
                <base-table ref="tableMasterPasien"
                    ...
                    <template v-slot:tbl-body>
                        <tbody v-if="pasienLists">                            
                            <row-modal-pasien v-if="pasienLists.length > 0" 
                                v-for="dt in pasienLists" 
                                :rowData="dt" 
                                :fnPasienSelected="selectedPasien">
                            </row-modal-pasien>
                            <tr v-else>
                                <td colspan="7"  style="text-align:center;">
                                    <h4 style="font-style:italic;">data tidak ditemukan</h4>
                                </td>
                            </tr>
                        </tbody>
                    </template>
...
import RowModalPasien from '@/Pages/Pendaftaran/components/ModalPasien/RowModalPasien.vue';
...
export default {
    ...
    name : 'modal-pasien',
    components : { BaseTable,RowModalPasien },
    data() {
        return {
            isUpdate : false,
            isLoading : true,
            ...
            tbBaseColumns : [
                ...
                { name : 'is_aktif', title : '...', colType : 'boolean', isSearchable : false, }        
            ], 
