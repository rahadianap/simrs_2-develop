        ...
        <vue3-html2pdf :show-layout="false" :float-layout="true" :enable-download="false" :preview-modal="true"
            ...
            <template v-slot:pdf-content>
                ...
                <div class="uk-width-1-1">
                    <h3 class="uk-text-bolder uk-text-center uk-text-large" style="font-size:20px;margin-top:-5px;"><u>RESEP OTC</u></h3>
                </div>
                <div class="uk-child-width-expand@s uk-text-center" uk-grid>
                    ...
                    <div>
                        <div class="uk-width-1-1 uk-margin-small-top">
                            ...
                            <h3 class="uk-text-bold uk-text-left uk-text-default" style="font-size:14px;margin-top:-15px;margin-left: -75px;">{{ reportData.item_nama }}</h3>
                            <h3 class="uk-text-normal uk-text-left uk-text-default" style="font-size:14px;margin-top:-15px;margin-left: -75px;">{{ reportData.signa + ' ' + reportData.signa_desc}}</h3>
                ...
                <div class="uk-width-1-1 uk-margin-medium-top">
                    <table align="left" class="css-serial uk-table uk-table-small uk-table-divider" style="font-size:10px;margin-top:-50px;border:0.1px solid #000000;border-collapse:collapse;">
                        <tr>
                            <th style="color:black;border: 0.1px solid #000000;font-size:12px;border-collapse:collapse;">07.00</th>
                            <th style="color:black;border: 0.1px solid #000000;font-size:12px;border-collapse:collapse;">12.00</th>
                            <th style="color:black;border: 0.1px solid #000000;font-size:12px;border-collapse:collapse;">18.00</th>
                        </tr>
...
export default {
    ...
    methods: {
        ...
        generateReport(data) {
            console.log(data);
            this.reportData.trx_id = data[1].trx_id;
            this.reportData.item_nama = data[1].item_nama;
            this.reportData.signa = data[1].signa;
            this.reportData.signa_desc = data[1].signa_deskripsi;
