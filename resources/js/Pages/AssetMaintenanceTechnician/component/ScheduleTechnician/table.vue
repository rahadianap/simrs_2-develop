<template>
    <div style="margin-top:1em;">
        ...
        <base-table-asset ref="tableScheduleTechnician"
...
export default {
  watch: {
        ...
        methods : {
            ...
            updateData(schedule){
                this.CLR_ERRORS();
                    this.$refs.editFormSchedule.editSchedule(schedule.maint_schedule_id);        
            ...
            refreshTable() {
                this.$refs.tableScheduleTechnician.retrieveData();
            },
