                    ...
                    <div style="margin:0 10px;border-top:2px solid #cc0202;">                  
                        ...
                        <div class="uk-grid-small hims-form-subpage-asset" style="margin:30px 0" uk-grid >
                            <div class="uk-width-1-1@s uk-grid-small" style="margin-left:1px;padding-left:1px;" uk-grid>
                                ...
                                <!-- tanggal realisasi -->
                                <div class="uk-width-1-2@m" style="padding-left:1px;padding-right: 10px">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tanggal Realisasi*</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="mschedule.tgl_realisasi" type="date" placeholder="masukkan tanggal rencana" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-2@m" style="padding-left:1px;padding-right: 10px">
                                    ...
                                    <div class="uk-form-control">
                                        <select class="uk-select uk-form-small" v-model="mschedule.status" required>
                                ...
                                <div class="uk-width-1-2@m" style="padding-left:1px;padding-right: 10px">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="mschedule.catatan" type="text" placeholder="masukkan catatan" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-2@m" style="padding-left:1px;padding-right: 10px">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="mschedule.tindak_lanjut" type="text" placeholder="tindak lanjut" required>
                                    </div>
                                </div>
