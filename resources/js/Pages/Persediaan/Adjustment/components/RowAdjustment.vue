    ...
    <tr v-if="rowData" style="border-bottom:1px solid #ccc;">
        ...
        <td>
            <div class="uk-inline" style="margin:0;padding:0;">
                ...
                <p style="font-size:11px; margin:0;padding:0;font-weight: 400;">{{rowData.tgl_sa}}</p>            
            </div>    
        </td>
        ...
        <Transition>
            <td colspan="8" v-if="isExpanded" style="background-color:#fefefe;border-bottom:1px solid #eee;">
                <div style="padding:0;margin:0;">
                    <h5 style="font-weight:500;padding:0;margin:0;">ITEM PENYESUAIAN</h5>
                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:1em 0 0 0;">
                        <thead>
                            ...
                            <th class="child-table-header" style="width:80px; text-align:center;padding:1em;">Awal</th>
                            <th class="child-table-header" style="width:80px; text-align:center;padding:1em;">Penyesuaian</th>
                            <th class="child-table-header" style="width:80px; text-align:center;padding:1em;">Akhir</th>
                        ...
                        <tbody>
                            <tr v-for="child in rowData.items">
                                ...
                                <td style="width: 80px;padding:1em; text-align:center;">{{child.total_awal}}</td>
                                <td style="width: 80px;padding:1em; text-align:center;">{{child.jml_penyesuaian}}</td>
                                <td style="width: 80px;padding:1em; text-align:center;">{{child.total_akhir}}</td>
                                <td style="width: auto;padding:1em; text-align:center;" class="uk-text-uppercase">{{child.satuan}}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
