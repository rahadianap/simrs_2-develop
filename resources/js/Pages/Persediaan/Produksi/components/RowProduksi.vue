    ...
    <tr v-if="rowData" style="border-bottom:1px solid #ccc;">
        ...
        <td>
            <div style="margin:0;padding:0;">
                ...
                <p style="font-size:11px; margin:0;padding:0;font-weight: 400;">{{rowData.tgl_produksi}}</p>            
            </div>    
        </td>
        ...
        <td class="uk-text-uppercase">
            <p style="margin:0;padding:0;font-weight: 500;">{{rowData.produk_hasil}} ({{rowData.jml_hasil}} {{rowData.satuan}})</p>
            <p style="font-size:11px; margin:0;padding:0;">{{rowData.produk_hasil_id}}</p>
        </td>
        <td class="uk-text-uppercase">
            <p style="margin:0;padding:0;font-size:12px;max-width:300px;">{{rowData.catatan}}</p>
        </td>
        <td class="uk-text-uppercase">
            <p style="margin:0;padding:0;">{{dateFormatting(rowData.tgl_selesai)}}</p>
        </td>
        <td class="uk-text-uppercase">
        ...
        <Transition>
            <td colspan="8" v-if="isExpanded" style="background-color:#fefefe;border-bottom:1px solid #eee;">
                <div style="padding:0;margin:0;">
                    <h5 style="font-weight:500;padding:0;margin:0;">ITEM PRODUKSI</h5>
                    <table class="uk-table uk-table-striped child-table" style="padding:0;margin:1em 0 0 0;">
                        <thead>
                            ...
                            <th class="child-table-header" style="text-align:left;padding:1em;">Tipe</th>
                            <th class="child-table-header" style="text-align:left;padding:1em;">Nama Produk</th>
                            <th class="child-table-header" style="width:80px; text-align:center;padding:1em;">Jml.Hasil</th>
                            <th class="child-table-header" style="width:80px; text-align:center;padding:1em;">Jml.Bahan</th>
                        ...
                        <tbody>
                            <tr v-for="child in rowData.items">
                                ...
                                <td style="width: auto;">
                                    <span v-if="child.is_hasil" class="uk-label" style="font-size: 11px;">HASIL</span>
                                    <span v-else  class="uk-label uk-label-success" style="font-size: 11px;">BAHAN</span>
                                </td>
                                <td style="width: auto;">{{child.produk_nama}}</td>
                                <td style="width: 80px; text-align:center;">{{child.jml_hasil}}</td>
                                <td style="width: 80px; text-align:center;">{{child.jml_bahan}}</td>
