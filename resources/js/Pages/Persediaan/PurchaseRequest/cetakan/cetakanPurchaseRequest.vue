                ...
                <div class="uk-grid-small" uk-grid>
                    <div>
                        <div class="uk-width-1-1 uk-margin-small-top uk-margin-auto-right uk-text-left">
                            <h3 class="uk-text-emphasis" style="color:black;margin-left:28px;margin-top:28px;font-size:20px;font-weight: 500;">FORM PERMINTAAN PEMBELIAN BARANG</h3>
                        </div>
                    </div>
                </div>
                <div class="uk-grid-small" uk-grid>
                    ...
                    <div>
                        <div class="uk-width-1-1 uk-margin-small-top uk-margin-auto-right uk-text-left">
                            ...
                            <h3 class="uk-text-bold" style="color:black;margin-left:28px;margin-top:-10px;font-size:14px;">Depo
                            </h3>
                        </div>
                    </div>
                    <div>
...
export default {
    ...
    methods: {
        ...
        generateReport(data) {
            ...
            this.reportData.pr_id = data[0].pr_id;
            this.reportData.tgl_pr = this.getDate(data[0].tgl_pr);
            this.reportData.tgl_kebutuhan = this.getDate(data[0].tgl_kebutuhan);
            this.reportData.unit = data[0].unit_nama;
            this.reportData.depo = data[0].depo_nama;
            ...
            for(let i=0;i<=data.length-1;i++) {
                this.reportData.detail.push({
                    ...
                    'jumlah': data[i].jml_pr,
                    'satuan': data[i].pr_satuan,
                });
            }
