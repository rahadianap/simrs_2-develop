<template>
    <div id="modal-preview-distribusi" class="uk-modal-container" uk-modal>
    <div class="uk-modal-dialog uk-modal-body">
        <button class="uk-modal-close-default" type="button" uk-close></button>
        <h2 class="uk-modal-title">DISTRIBUSI PERSEDIAAN</h2>
        <div>
            <table>
                <tr>
...
export default {
    ...
    methods : {
        ...mapActions('distribusi',['dataDistribusi']),
        ...
        viewData(distribusiId) {
            ...
            this.dataDistribusi(distribusiId).then((response)=>{
                if (response.success == true) {
                    ...
                    UIkit.modal('#modal-preview-distribusi').show();
                } 
