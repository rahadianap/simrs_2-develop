                ...
                <div class="uk-grid-small" uk-grid>
                    <div>
                        <div class="uk-width-1-1 uk-margin-small-top uk-margin-auto-right uk-text-left">
                            <h3 class="uk-text-emphasis" style="color:black;margin-left:28px;margin-top:28px;font-size:20px;font-weight: 500;">FORM PENERIMAAN PEMBELIAN BARANG</h3>
                        </div>
                    </div>
                </div>
                <div class="uk-grid-small" uk-grid>
                    <div>
                        <div class="uk-width-1-1 uk-margin-small-top uk-margin-auto-right uk-text-left">
                            ...
                            <h3 class="uk-text-bold" style="color:black;margin-left:28px;margin-top:-10px;font-size:14px;font-weight: 500;">Nomor Invoice
                            </h3>
                        </div>
                    </div>
                    <div>
                        <div class="uk-width-1-1 uk-margin-small-top uk-margin-auto-right uk-text-left">
                            <h3 class="uk-text-bold" style="color:black;margin-left:5px;margin-top:-28px;font-size:14px;font-weight: 500;">{{(':  ' +
                                                        reportData.no_transaksi)}}</h3>
                            <h3 class="uk-text-bold" style="color:black;margin-left:5px;margin-top:-10px;font-size:14px;font-weight: 500;">{{(':  ' +
                                                        reportData.no_invoice)}}</h3>
                        </div>
                    </div>
                    <div>
                        <div class="uk-width-1-1 uk-margin-small-top uk-margin-auto-right uk-text-left">
                            <h3 class="uk-text-bold" style="color:black;margin-left:28px;margin-top:-28px;font-size:14px;">Reference
                            </h3>
                            <h3 class="uk-text-bold" style="color:black;margin-left:28px;margin-top:-10px;font-size:14px;">Unit
                            </h3>
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            <table align="center" class="css-serial" style="font-size:14px;font-weight:500;border:0.1px solid #000000;font-family: arial,sans-serif;border-collapse:collapse;width:100%;">
                                <tr>
                                    ...
                                    <th style="color:black;border: 0.1px solid #000000;background-color:#c9c9c9;border-collapse:collapse;text-align: center;padding: 8px;width: 350px">Nama Produk</th>
                                ...
                                <tr v-for="dt in reportData.detail">
                                    ...
                                    <td style="color:black;border: 0.1px solid #000000;border-collapse:collapse;text-align: left;padding: 8px;width: 350px">{{dt['produk_nama']}}</td>
...
export default {
    ...
    methods: {
        ...
        generateReport(data) {
            ...
            this.reportData.no_transaksi = data[0].no_transaksi;
            this.reportData.no_invoice = data[0].no_invoice;
            this.reportData.unit = data[0].unit_nama;
            this.reportData.reference = data[0].reff_trx_id;
