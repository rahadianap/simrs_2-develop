        ...
        <ul class="uk-switcher" style="padding:0;margin:0;">
            <li>
                <div class="uk-container uk-container-xlarge" style="padding:0;">
                    <header-page title="PURCHASE MANAGEMENTS" subTitle="pegelolaan data pembelian persediaan"></header-page>
                        ...
                        <base-table ref="tablePurchaseReceive"
                            ...
                            <template v-slot:tbl-body>
                                <tbody v-if="dataLists" style="min-weight:50vh;">
                                    <row-purchase-management
                                        v-for="dt in dataLists" 
                                        :rowData="dt" :rowFunctions = "editPurchaseManagement">
                                    </row-purchase-management>
                                </tbody>
                            </template>
                        </base-table>
...
import RowPurchaseManagement from '@/Pages/Persediaan/PengelolaanPengadaan/components/RowPurchaseManagement.vue';
    ...
    components : {
        ...
        data() {
            return {
                ...
                searchUrl : '/purchases/managements',
                dataLists : null,
             }
        },
        methods: {
