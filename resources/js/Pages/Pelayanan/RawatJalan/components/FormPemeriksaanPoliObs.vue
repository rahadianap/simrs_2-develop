                        ...
                        <div class="hims-form-subpage" style="padding:0;margin:0;border:none;width:100%;">
                            <div>
                                <ul id="switcherPemeriksaanPoli" class="uk-tab hims-penunjang-tab" uk-switcher style="padding:0;margin:0;">
                                    ...
                                    <li style="padding:0;"><div><a href="#"><h5>Tindakan (Pemeriksaan)</h5></a></div></li>
                    ...
                    <div class="hims-form-container" style="padding:0 1.5em 2em 1.5em; margin:0;">     
                            ...
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;"> 
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-inline uk-width-1-1">
                                        ...
                                        <input class="uk-input uk-form-small" v-model="poliTransaction.nama_pasien" 
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="text" v-model="poliTransaction.no_rm" style="color:black;" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="text" v-model="poliTransaction.pasien_id" style="color:black;" disabled>
                                    </div>
                                </div>
                                <div class="uk-width-1-4@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Jenis Penjamin*</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="text" v-model="poliTransaction.jns_penjamin" style="color:black;" disabled>
                                    </div>
                                </div>
                                <div class="uk-width-1-2@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Nama Penjamin*</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="text" v-model="poliTransaction.penjamin_nama" style="color:black;" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="poliTransaction.no_kepesertaan" type="text" style="color:black;" required disabled>
                                    </div>
                                </div>
                                <div class="uk-width-1-4@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">NIK (KTP / ID Card)*</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" v-model="poliTransaction.nik" type="text" style="color:black;" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <select v-model="poliTransaction.jns_kelamin" class="uk-select uk-form-small" required>
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="text" v-model="poliTransaction.tempat_lahir" style="color:black;">
                                    </div>
                                </div>
                                <div class="uk-width-1-4@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Tgl Lahir*</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="date" v-model="poliTransaction.tgl_lahir" style="color:black;" :max="minDate">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid>                        
                            <div class="uk-width-1-4@m" style="padding:0 0.5em 1em 0.5em;">
                                ...
                                <p style="font-size:12px;font-style:italic;padding:0;margin:0;">
                                    detail data pemeriksaan laboratorium.
                                </p>
                            </div>
                            <div class="uk-width-3-4@m uk-grid-small" uk-grid  style="padding:0 0.5em 0.2em 0.5em;">
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="date" v-model="poliTransaction.tgl_periksa" style="color:black;" :min="minDate">
                                    </div>
                                </div>
                                <div class="uk-width-1-4@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Jam Periksa*</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="time" v-model="poliTransaction.jam_periksa" style="color:black;">
                                    </div>
                                </div>
                                <div class="uk-width-1-2@m">
                                    <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Unit*</label>
                                    <div class="uk-form-controls">
                                        <select v-model="poliTransaction.unit_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;color:black;" @change="unitSelected"> 
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <select v-model="poliTransaction.ruang_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;color:black;" @change="ruangSelected"> 
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <select v-model="poliTransaction.dokter_id" class="uk-select uk-form-small" style="border:1px solid #cc0202;color:black;" @change="dokterSelected"> 
                                ...
                                <div class="uk-width-1-2@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="text" v-model="poliTransaction.dokter_pengirim" style="color:black;" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <select v-model = "poliTransaction.kelas_harga" class="uk-select uk-form-small" style="border:1px solid #cc0202;color:black;" required @change.prevent="updateKelasHarga" disabled>
                                ...
                                <div class="uk-width-1-4@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small" type="text" v-model="poliTransaction.asal_pasien" style="color:black;"  disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0;">
                                    ...
                                    <tbody>                                               
                                        <row-form-registrasi-lab 
                                            v-if="poliTransaction.detail" 
                                            v-for="dt in poliTransaction.detail"
                                            :rowData = "dt"
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size:14px;font-weight:500;text-align:right;color:black;padding:0.5em;">{{formatCurrency(poliTransaction.total)}}</td>
                                            <td></td>
                                        </tr>
                                    </tbody>
                                </table>
...
import SubFormTindakan from '@/Pages/Pelayanan/RawatJalan/components/SubFormTindakan';

export default {
    name : 'form-pemeriksaan-poli',
    components : { 
        SearchSelect,
        SearchList,
        ModalPickerRuang, 
