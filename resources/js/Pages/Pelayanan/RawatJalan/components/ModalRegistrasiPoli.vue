<template>
    <div class="uk-modal uk-modal-container" uk-modal="bg-close:false;" id="modalRegPoli" style="min-height:50vh;">
                            ...
                            <div class="uk-grid-small uk-card1 uk-card-default1 hims-form-header" uk-grid style="padding:0;margin:0;">                        
                                <div class="uk-width-1-1" style="margin:0 0 0.5em 0;padding:0.5em 0 0 0.5em;">
                                    <div class="uk-grid-small uk-box-shadow-large" uk-grid style="border-radius:5px;padding:0;">
                                        <button type="button" class="hims-table-btn uk-width-auto" @click.prevent="closeModalRegPoli" style="padding:0.5em;"><span uk-icon="ban"></span> Tutup</button>
                                        ...
                                        <button :disabled="isLoading" type="button" @click.prevent="" class="hims-table-btn uk-width-auto" style="padding:0.5em;"><span uk-icon="file-edit"></span> Ubah Registrasi</button>
...
export default {
    ...
    methods : {
        ...
        closeModalRegPoli(){
            this.CLR_ERRORS();
            this.clearDataReg();
            UIkit.modal('#modalRegPoli').hide();
        },

        showModal(data){
            this.CLR_ERRORS();
            UIkit.modal('#modalRegPoli').show();                    
            this.clearDataReg();
            if(data) {
                this.isLoading = true;
