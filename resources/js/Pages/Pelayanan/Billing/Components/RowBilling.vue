<template>
    <tr v-if="rowData" style="border-top:1px solid #ccc;">
        ...
        <td>
            <div v-if="rowFunctions" style="margin:0;padding:0;">
                <template v-if="rowFunctions.length > 1">
                    <a href="#" class="row-link-menu" style="margin:0;padding:0;">
                        <!-- {{rowData.tgl_registrasi}} -->
                        {{rowData.tgl_transaksi}}
                        <p style="margin:0;padding:0;font-weight:350;">{{rowData.reg_id}}</p>
                    </a>
                    <div uk-dropdown="mode: click">
                        <ul class="uk-list" style="margin:0;padding:0;">
                            <li :key="rf" v-for="rf in rowFunctions">
                ...
                <template v-else>
                    <a href="#" @click.prevent="rowFunctions[0].callback(rowData)" class="row-link-menu" style="margin:0;padding:0;">
                        <!-- {{rowData.tgl_registrasi}} -->
                        {{rowData.tgl_transaksi}}
                        <p style="margin:0;padding:0;font-weight:350;">{{rowData.reg_id}}</p>
                    </a>
        ...
        <td>
            <p class="uk-text-uppercase" style="margin:0;padding:0;font-weight: 500;">{{rowData.jns_transaksi}}</p>
        </td>
        <td>
            <p class="uk-text-uppercase" style="margin:0;padding:0;font-weight: 500;">{{rowData.nama_pasien}}</p>
        ...
        <!-- <td>
            <p class="uk-text-uppercase" style="margin:0;padding:0;font-weight: 500;">{{rowData.jns_registrasi}}</p>
        </td> -->
        ...
        <Transition>            
            <td colspan="9" v-if="isExpanded" style="background-color:whitesmoke;border-bottom:1px solid #eee;">
                <div style="padding:0;margin:0;">
                    ...
                    <div> -->
                        <!-- <ul class="uk-tab hims-poli-tab" uk-switcher style="padding:0;margin:0;">
                            <li><div><a href="#"><h5>Registrasi</h5></a></div></li>
                            <li style="padding:0;"><div><a href="#"><h5>Transaksi</h5></a></div></li>
                        </ul>
                        <ul class="uk-switcher">
                            ...
                            <li style="padding:0;margin:0;background-color: #fff;">
                                <table class="uk-table uk-table-striped child-table" style="padding:0;margin:0 0 0 0;background-color:#fff;">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr v-for="trx in rowData.transaksi" style="background-color: #fff;">
                                            <td style="width: 130px;padding:1em; text-align:center;font-weight: 500;">{{trx.tgl_transaksi}}</td>
                                            <td style="width: 130px;padding:1em; text-align:left;font-weight: 500;">{{trx.jns_transaksi}}</td>
                                            ...
                                            <td style="width: 80px;padding:1em; text-align:right;">{{formatCurrency(trx.total)}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </li>
