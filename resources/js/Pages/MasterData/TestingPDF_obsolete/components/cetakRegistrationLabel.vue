<template>
    <div style="padding: 2em;">
            <div class="uk-container paper-like-landscape" style="padding:auto;">
                <div style="position: sticky;top:10px;z-index:100;">
                    <div class="uk-width-1-1 uk-text-right">
                        ...
                        <input class="submit" type="submit" value="Print" style="margin-right:-120px" @click="printDiv('cetakLabel')">
                    </div>
                </div>
               
                <ul style="padding:0;margin:0;" id="cetakLabel" ref="cetakLabel">
                        ...
                        <div style="padding:1em 2em;" class="uk-container">
                            <div style="padding:0;border-radius:10px;min-height:400px;" id="pdf-body-b">
                                ...
                                <div class="uk-align-center uk-margin-medium">
                                    <div>
                                        <p class="uk-margin-small" style="font-size:20px;font-weight:bold;text-align:center;font-family: verdana-bold;letter-spacing:1.1px;">CETAK REGISTRATION LABEL</p>
                                    </div>
                                </div>
                                ...
                                <table style="width:100%;font-size:14px;letter-spacing:0.5px;" class="uk-margin-small">
                                    ...
                                    <tr>
                                        ...
                                        <!-- Kanan -->
                                        <td style="font-family:cour;font-weight:bold;">Usia</td>
                                        <td style="font-family:cour">: 44 tahun 8 bulan</td>
                                    </tr>
                                ...
                                <!-- Data Barcode Pasien -->
                                <!-- <div class="uk-flex-center uk-align-center" style="margin-top:35px;" v-for="index in 2" :key="index">
                                    <div class="uk-margin-small">
                                        <img src="../../../../Assets/barcode-pasien.jpg" style="width:1058px">
                                    </div>
                                    <div class="uk-margin-small">
                                        <h4 style="font-family: cour;font-size:35px;text-align:center;letter-spacing:1em;" contenteditable>RM-134827</h4>
                                    </div>
                                </div> -->
...
import Barcode from './BarCode/index.vue';
...
function onContentLoad() {
    ...
    methods : {
        ...
        printDiv(pdf_body) {
            ...
            frameDoc.document.write('<style>@page { zoom: 90%; } hr { margin:0px !important; } ul { list-style-type: none; }</style>');
            frameDoc.document.write('<div class="print-content">'+contents+'</div>');
            frameDoc.document.write(svgData);
        ...
        // printToPDF() {
        //     const content = this.$refs.cetakLabel;
        //     const options = {
...
.paper-like-landscape {
    ...
    align-items: center;
    width: 297mm;
    /* height: 210mm; *height untuk kertas a4 landscape * */
    height: auto;
