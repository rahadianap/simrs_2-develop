            ...
            <div class="uk-container paper-like" style="padding:auto;">
                <div style="position: sticky;top:10px;z-index:100;">
                    <div class="uk-width-1-1 uk-text-right">
                        <input class="submit" type="submit" value="Print" style="margin-right:-120px" @click="printDIV('cetakFormInap')">
                    </div>
                </div>

                <ul style="padding:0;margin:0;" id="cetakFormInap">
                        ...
                        <div style="padding:1em 2em;" class="uk-container">
                            <div style="padding:0;border-radius:10px;min-height:400px;" id="pdf-body-b">
                                ...
                                <div class="uk-align-center uk-margin-medium">
                                    <div>
                                        <p class="uk-margin-small" style="font-size:20px;font-weight:bold;text-align:center;font-family: verdana-bold;letter-spacing:1.1px;text-decoration: underline">FORM PENEMPATAN KELAS RAWAT INAP</p>
                                    </div>
                                    <div>
                                        <p class="uk-margin-small" style="font-size:16px;text-align:center;font-family:verdana;letter-spacing:1.3px;">Lampiran Form No.IV/PKRI/2023</p>
                                    </div>
                                </div>
                                ...
                                <div class="uk-margin-medium-top uk-padding-small">
                                    <div class="uk-margin-medium">
                                        <input class="form uk-checkbox" type="checkbox" style="padding:10px;border-radius:3px;width:35px;height:28px;box-shadow: 1px 1px 0 var(--color-black);border: 0.2px solid var(--color-black);"><span style="margin-left:15px;font-family:cour;font-size:13px;letter-spacing:1.1px">Kehendak sendiri dan seluruh biaya ditanggung pribadi.</span>
                                    </div>
                                    <div class="uk-margin-medium">
                                        <input class="form uk-checkbox" type="checkbox" style="padding:10px;border-radius:3px;width:35px;height:28px;box-shadow: 1px 1px 0 var(--color-black);border: 0.2px solid var(--color-black);"><span style="margin-left:15px;font-family:cour;font-size:13px;letter-spacing:0.8px">Kehendak sendiri dan selisih biaya kamar ditanggung pribadi (diluar kamar ditanggung Penjamin).</span>
                                    </div>
                                    <div class="uk-margin-medium">
                                        <input class="form uk-checkbox" type="checkbox" style="padding:10px;border-radius:3px;width:35px;height:28px;box-shadow: 1px 1px 0 var(--color-black);border: 0.2px solid var(--color-black);"><span style="margin-left:15px;font-family:cour;font-size:13px;letter-spacing:0.8px">Seluruh selisih biaya ditanggung perusahaan penjamin.</span>
                                        
                                    </div>
                                    <div class="uk-margin-medium">
                                        <input class="form uk-checkbox" type="checkbox" style="padding:10px;border-radius:3px;width:35px;height:28px;box-shadow: 1px 1px 0 var(--color-black);border: 0.2px solid var(--color-black);"><span style="margin-left:15px;font-family:cour;font-size:13px;letter-spacing:0.8px">Hak kelas penuh maka setelah 2 x 24 jam seluruh biaya ditanggung pribadi.</span>
                                    </div>
                                    <div class="uk-margin-medium">
                                        <input class="form uk-checkbox" type="checkbox" style="padding:10px;border-radius:3px;width:35px;height:28px;box-shadow: 1px 1px 0 var(--color-black);border: 0.2px solid var(--color-black);"><span style="margin-left:15px;font-family:cour;font-size:13px;letter-spacing:0.8px">dll. Karena <span style="border-bottom: 1.5px dotted #000;width:450px;border-radius:0%;" contenteditable>(isi disini)</span></span>
                                    </div>
                                </div>
                                <!-- footer -->
                                <div class="uk-container uk-flex uk-flex-middle uk-card-body uk-margin-large-top" style="font-family: verdana-bold;">

                                    <div class="uk-width-1-2 uk-text-center">
                                        <div>
                                            <p>Pasien/PenanggungJawab</p>
                                        </div>
                                        <div :style="tandaTanganPenerima()">
                                            <img src="../../../../Assets/signatures/ttd-pasien.png" style="width:100px;">
                                        </div>
                                        <div>
                                            <p>( <span contenteditable style="text-decoration: underline;">Nama Pasien</span> )</p>
                                        </div>
                                    </div>
...
function onContentLoad() {
    ...
    methods : {
        ...
        printToPDF() {
            const content = this.$refs.cetakFormInap;
            const options = {
...
table.balance-pasien td { text-align: right; }
/* aside */
