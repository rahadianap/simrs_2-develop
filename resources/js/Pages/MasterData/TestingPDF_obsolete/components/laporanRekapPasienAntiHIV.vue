        ...
        <div class="uk-container paper-like" style="padding:0 1em 10em;height: auto;" >
            <div style="position: sticky;top:10px;z-index:100;">
                <div class="uk-width-1-1 uk-text-right">
                    <input class="submit" type="submit" value="Print" style="margin-right:-120px" @click="printDiv('laporanRekapPasienAntiHIV')">
                </div>
            </div>
            <ul style="padding:0;margin:0;" id="laporanRekapPasienAntiHIV">
                    ...
                    <div style="padding:1em 0 1em 0;" class="uk-container">
                        <div style="padding:0; margin-top:1em; border-radius:10px;min-height:400px;" id="pdf-body-b">
                            ...
                            <div class="uk-align-center uk-margin-medium">
                                <div>
                                    <p class="uk-margin-small" style="font-size:16px;font-weight:bold;text-align:center;font-family: verdana-bold;letter-spacing:1.1px;text-decoration: underline">LAPORAN REKAP HASIL PASIEN ANTI HIV</p>
                            ...
                            <table style="border:0.5px solid black;width:100%;font-size:11px;letter-spacing:0.5px;" class="uk-margin-small">
                                <thead>
                                    <tr>
                                        <th style="border-bottom:0.5px solid black;">Tanggal</th>
                                        <th style="border-bottom:0.5px solid black;">No. RM</th>
                                        <th style="border-bottom:0.5px solid black;">Nama Pasien</th>
                                        <th style="border-bottom:0.5px solid black;">No. Lab</th>
                                        <th style="border-bottom:0.5px solid black;">Nama Unit</th>
                                        <th style="border-bottom:0.5px solid black;">Nama Dokter</th>
                                        <th style="border-bottom:0.5px solid black;">Test</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-if="data_rekap" v-for="drekap in data_rekap">
                                        <td style="border-bottom:0.5px solid black;">{{ drekap.tanggal_periksa }}</td>
                                        ...
                                        <td style="border-bottom:0.5px solid black;">{{ drekap.hasil_nama }}</td>
                                    </tr>
                                    <tr v-if="data_rekap" v-for="drekap in data_rekap">
                                        <td style="border-bottom:0.5px solid black;">{{ drekap.tanggal_periksa }}</td>
                                        <td style="border-bottom:0.5px solid black;">{{ drekap.no_rm }}</td>
...
export default {
    ...
    methods : {
        ...
        callData(){
            this.dataPasienAntiHIV().then((response) => {
                if (response.success == true) {
                    this.data_rekap = response.data.data;
                    this.periode = response.data.periode;
                }
                else { alert('data rawat pasien anti hiv tidak ditemukan'); this.isLoading = false; }
            })
        }
