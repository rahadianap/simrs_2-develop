            ...
            <div class="uk-container paper-like" style="padding;auto;">
                ...
                <div style="position: sticky;top:10px;z-index:100;">
                    <div class="uk-width-1-1 uk-text-right">
                        ...
                        <input class="submit" type="submit" value="Print" style="margin-right:-120px" @click="printDiv('cetakMarketingPayer')">
                    </div>
                </div>
               
                <ul style="padding:0;margin:0;" id="cetakMarketingPayer" ref="cetakMarketingPayer">
                        ...
                        <div style="padding:1em 2em;" class="uk-container">
                            <div style="padding:0;border-radius:10px;min-height:400px;" id="pdf-body-b">
                                ...
                                <div class="uk-container uk-flex uk-flex-middle uk-card-body">
                                    ...
                                    <div>
                                        <div class="uk-flex-start" style="font-size:15px;font-weight:bold;font-family: verdana;letter-spacing:1px;text-decoration: uppercase">
                                            <p>Rumah Sakit Kebagusan Jaksel</p>
                                            <p class="uk-margin-small" style="font-weight: normal;">Jl. Kebagusan Raya No.192 Pasar Minggu, Jaksel</p>
                                            <p class="uk-margin-small" style="font-weight: normal;">Telp. +62-21-78838951 | Email: support@kp3.co.id</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Judul Laporan -->
                                <div class="uk-align-center uk-margin-small">
                                    <div>
                                        <p class="uk-margin-small" style="font-size:16px;font-weight:bold;text-align:center;font-family: verdana-bold;letter-spacing:1.1px;">LAPORAN MARKETING PER PAYER</p>
                                    </div>
                                    <div>
                                        <p class="uk-margin-small" style="font-size:15px;text-align:center;font-family:verdana;letter-spacing:1.3px;">Periode: 01 Dec 2022 s/d 02 Feb 2023</p>
                                    </div>
                                </div>
                                ...
                                <div class="uk-margin-small-top ">
                                    <table class="uk-table uk-table-small uk-table-hover printpdf" >
                                    <thead style="font-size:11px;font-family: cour;font-weight:bold;">
                                        <tr>
                                            <th style="vertical-align: middle;"><span contenteditable>No.</span></th>
                                            <th style="vertical-align: middle;"><span contenteditable>Penjamin</span></th>
                                            <th style="vertical-align: middle;"><span contenteditable>Rawat Jalan</span></th>
                                            <th style="vertical-align: middle;"><span contenteditable>Rawat Inap</span></th>
                                            <th style="vertical-align: middle;"><span contenteditable>Total</span></th>
                                            <th style="vertical-align: middle;"><span contenteditable>Jumlah Pasien Rawat Jalan</span></th>
                                            <th style="vertical-align: middle;"><span contenteditable>Jumlah Pasien Rawat Inap</span></th>
                                        </tr>
                                    
                                    </thead>
                                    <tbody style="font-size:10px;font-family: cour;">
                                        <tr>
                                            <th colspan="7" style="text-align: left;vertical-align: middle;background-color:rgb(249 249 249);"> ABADI SMILYNKS, PT </th>
                                        </tr>
                                        <tr>
                                            <td><span contenteditable>1.</span></td>
                                            <td><span contenteditable>ABADI SMILYNKS, PT - PACIFIC PLACE JAKARTA,PT</span></td>
                                            <td><span contenteditable>1,723,608.00</span></td>
                                            <td><span contenteditable>1,240,000.00</span></td>
                                            <td><span contenteditable>0</span></td>
                                            <td><span contenteditable>0</span></td>
                                            <td><span contenteditable>0</span></td>
                                        </tr>
                                        <tr>
                                            <th colspan="7" style="text-align: left;vertical-align: middle;background-color:rgb(249 249 249);"> ABDA ( ASURANSI BINA DANA ARTA ) </th>
                                        </tr>
                                        <tr>
                                            <td><span contenteditable>1.</span></td>
                                            <td><span contenteditable>ABDA ( ASURANSI BINA DANA ARTA ) - INDO PREMIER SEKURITAS PT</span></td>
                                            <td><span contenteditable>3,111,542</span></td>
                                            <td><span contenteditable>0</span></td>
                                            <td><span contenteditable>3,111,542</span></td>
                                        ...
                                        <tr>
                                            <th colspan="7" style="text-align: left;vertical-align: middle;background-color:rgb(249 249 249);"> ADMINISTRASI MEDIKA ( ADMEDIKA ), PT </th>
                                        </tr>
                                        <tr>
                                            <td><span contenteditable>1.</span></td>
                                            <td><span contenteditable>AADMINISTRASI MEDIKA ( ADMEDIKA ), PT - PT. TUGU PRATAMA INDONESIA</span></td>
                                            <td><span contenteditable>2,930,479</span></td>
                                            <td><span contenteditable>0</span></td>
                                            <td><span contenteditable>2,930,479</span></td>
                                            <td><span contenteditable>2</span></td>
                                            <td><span contenteditable>0</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span contenteditable>2,930,479</span></td>
                                            <td><span contenteditable>2</span></td>
                                            <td><span contenteditable>483,608.00</span></td>

                                        </tr>

                                        <tr>
                                            <th colspan="2" style="text-align: right;vertical-align: middle;background-color:rgb(249 249 249);"> Grand Total </th>
                                            <td>Rp.2,657,350,131</td>
                                            <td>Rp.2,105,198,795</td>
                                            <td>Rp.4,762,548,925</td>
                                            <td>Rp.5,561</td>
                                            <td>Rp.216</td>
                                        </tr>
                                    </tbody>
...
export default {
    ...
    methods : {
        ...
        printToPDF() {
            const content = this.$refs.cetakMarketingPayer;
            const options = {
