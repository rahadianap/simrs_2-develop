            ...
            <div class="uk-container paper-like" style="padding:auto">
                <div style="position: sticky;top:10px;z-index:100;">
                    <!-- <div class="uk-width-1-1 uk-text-right">
                        <input class="submit" type="submit" value="Print" style="margin-right:-120px" @click="printDiv('templateCetak')">
                    </div> -->
                    <div class="uk-grid" style="position: sticky;top:10px;z-index:100;" uk-grid>
                        <span class="uk-width-1-2 uk-text-left">
                            <span uk-icon="icon: download;ratio:1.1" class="submit" uk-tooltip="Unduh file PDF" style="margin-left:-120px" @click="downloadPDF"></span>
                        </span>
                ...
                <!-- <button class="btn btn-primary" @click="printDocument()">htmlToPdfmake</button> -->
                <!-- <button class="btn btn-primary" @click.prevent="callData()">callData</button> -->
                <!-- <ul id="switcherUserManagement" class="uk-tab hims-penunjang-tab" uk-switcher style="padding:0;margin:0;background-color: whitesmoke;"> -->
                    <!--// <li><div><a href="#"><h5>Tipe A</h5></a></div></li> -->
                    <!-- <li style="padding:0;"><div><a href="#"><h5>Tipe B</h5></a></div></li>  -->
                <!-- </ul> -->
                <ul style="padding:0;margin:0;" id="templateCetak"  ref="templateCetak">
                    <li style="padding:0;margin:0;">
                        <div style="padding:1em 2em;" class="uk-container">
                            <div style="padding:0;border-radius:10px;min-height:400px;" id="pdf-body-b">
                                ...
                                <!-- <div class="uk-container uk-flex uk-flex-middle uk-card-body">
                                    ...
                                    <div class="uk-width-1-2">
                                        <div class="uk-flex-center uk-text-center">
                                            ...
                                            <p class="uk-margin-small" style="font-size: 16px;font-family: verdana;letter-spacing:1.3px;">Jl. Kebagusan Raya No.192 Pasar Minggu, Jaksel</p>
                                            <p class="uk-margin-small" style="font-size: 16px;font-family: verdana;letter-spacing:1.3px;">Telp. +62-21-78838951 | Email: support@kp3.co.id</p>
                                        </div>
                                    </div>
                                </div>
                                <hr style="border:0.2px solid #cc0202;" /> -->
                                <kop-surat
                                    namaInstansi = "Rumah Sakit Kebagusan Jaksel"
                                    alamatInstansi = "Jl. Kebagusan Raya No.192 Pasar Minggu, Jaksel"
                                    kontakInstansi = "Telp. +62-21-78838951 | Email: support@kp3.co.id"
                                >
                                </kop-surat>
                                <!-- Judul Laporan -->
                                <div class="uk-align-center uk-margin-medium">
                                    <div>
                                        <p class="uk-margin-small" style="font-size:20px;font-weight:bold;text-align:center;font-family: verdana-bold;letter-spacing:1.1px;">RINCIAN BIAYA PERAWATAN</p>
                                    </div>
                                    <div>
                                        <p class="uk-margin-small" style="font-size:16px;text-align:center;font-family:verdana;letter-spacing:1.3px;">Periode Perawatan : 26-Dec-2022 s/d 29-Dec-2022</p>
                                    </div>
                                </div>
                                ...
                                <!-- <hr style="border:1px solid #cc0202;" /> -->
                                ...
                                <table style="width:100%;" class="uk-table uk-table-small uk-table-hover uk-margin-medium printpdf" >
                                    <thead style="font-size:13px;font-family: cour;font-weight:bold;">
                                        <tr>
                                            <th><span contenteditable>Uraian / Transaksi</span></th>
                                            <th ><span contenteditable>Tanggal</span></th>
                                            <th><span contenteditable>Satuan</span></th>
                                            <th><span contenteditable>Qty</span></th>
                                            <th><span contenteditable>Kelas</span></th>
                                            <th><span contenteditable>Diskon</span></th>
                                            <th><span contenteditable>Harga</span></th>
                                            <th><span contenteditable>Pasien</span></th>
                                        </tr>
                                    </thead>
                                    <tbody style="font-size:13px;font-family: cour;">
                                        <!-- <th rowspan="5" class="vertical-header" style="text-align: center;">Data Ruangan</th> -->
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;"> Data Ruangan</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                            <td><span data-prefix>Rp. </span><span id="prefix data-prefix" contenteditable>{{ dr.satuan }}</span></td>
                                            <td><span contenteditable>{{ dr.qty }}</span></td>
                                            <td><span contenteditable>{{ dr.kelas }}</span></td>
                                            <td><span contenteditable>{{ dr.diskon }}</span></td>
                                            <td><span data-prefix>Rp. </span><span id="prefix data-prefix">{{ dr.harga }}</span></td>
                                            <td><span contenteditable>{{ dr.pasien }}</span></td>
                                        </tr>
                                    ...
                                    <!-- </tbody> -->
                                    <!-- <tbody style="font-size:14px;font-family: cour;"> -->
                                        <!-- <th rowspan="5" class="vertical-header" style="text-align: center;">Data Obat</th> -->
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Obat</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                        ...
                                        <tr style="border-top: 0.1px solid #80808021;border-bottom: 0.1px solid #80808021;">
                                            <th colspan="5" style="text-align: right;background-color:rgb(249 249 249);"> Total Transaksi Obat</th>
                                            <td>Rp. 877</td>
                                            <td>Rp. 511</td>
                                            <td>Rp. 178</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Ruangan B</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                        ...
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Ruangan C</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                        ...
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Obat B</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                        ...
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Ruangan D</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                        ...
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Ruangan E</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                        ...
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Ruangan F</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                        ...
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Ruangan G</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                        ...
                                        <tr>
                                            <th colspan="9" style="background-color:#fff;font-weight:bold;border-bottom: 0.1px solid #80808021;border-top: 0.1px solid #80808021;"> Data Ruangan H</th>
                                        </tr>
                                        <tr v-if="data_ruang" v-for="dr in data_ruang">
                                            <td><span contenteditable>{{ dr.uraian }}</span></td>
                                            <td><span contenteditable>{{ dr.tanggal }}</span></td>
                                ...
                                <div class="uk-container uk-flex uk-flex-middle uk-margin-medium">
                                    <!-- balance instansi -->
                                    <div class="uk-width-1-2">
                                        <table class="balance" style="margin-right: 62.5px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-family: cour;"><span data-prefix>Rp. </span><span>{{ totalHarga().toFixed(2) }}</span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-family: cour;"><span data-prefix>Rp. </span><span>{{ belumBayar }}</span></td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <!-- balance pasien -->
                                    <div class="uk-width-1-2">
                                        <table class="balance-pasien"  style="margin-left: 62.5px;">
                                        <p style="font-family: cour;font-weight: bold;color: #22527a;text-transform:uppercase;margin-bottom: 5.5px;">
                                            Pasien
                                        </p>
                                        <tr>
                                ...
                                <div class="uk-container uk-flex uk-flex-middle uk-card-body" style="font-family: verdana-bold;">
                                    <div class="uk-width-1-2 uk-text-center">
                                        ...
                                        <div :style="tandaTanganPetugas()">
                                            <img src="../../../../Assets/signatures/ttd-petugas.png" style="width:100px;">
                                        </div>
                                        <div>
                                    ...
                                    <div class="uk-width-1-2 uk-text-center">
                                        ...
                                        <div :style="tandaTanganPenerima()">
                                            <!-- <p contenteditable>Nama Penerima</p> -->
                                            <img src="../../../../Assets/signatures/ttd-penerima.png" style="width:100px;">
                                        </div>
                                        <div>
...
import KopSurat from '../components/KopSurat/index.vue'
...
export default {
    ...
    methods : {
        ...
        // printToPDF() {
        //     const content = this.$refs.templateCetak;
        //     const options = {
        ...
        // printDocument() {
        //     const pdfTable = document.getElementById('pdfPrint');
