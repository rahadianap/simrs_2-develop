<template>
    <h3>TAHAP DEVELOPMENT. BLM FIX</h3>
    <div style="padding: 2em;">
            <div class="uk-container paper-like" style="padding:auto;">
                ...
                <ul style="padding:0;margin:0;" ref="cetakRiwayat">
                    
                    <li style="padding:0;margin:0;">
                        <!-- <button class="btn btn-primary" @click="printDiv('pdf-body-b')">NoPlugin</button> -->
                            ...
                            <div style="padding:0;border-radius:10px;min-height:400px;" id="pdf-body-b">
                                ...
                                <table style="width:100%;" class="uk-table uk-table-small uk-table-hover uk-margin-medium printpdf" >
                                    ...
                                    <tbody style="font-size:13px;font-family: cour;">
                                        ...
                                        <tr>
                                            <th colspan="6" style="text-align: right;background-color:rgb(249 249 249);"> Total Transaksi Ruangan</th>
                                            <td>Rp. 123</td>
                                            <td>Rp. 456</td>
                                            <td>Rp. 456</td>
                                        </tr>
                                    ...
                                    <!-- <tbody style="font-size:13px;font-family: cour;"> -->
                                        ...
                                        <tr>
                                            <th colspan="6" style="text-align: right;background-color:rgb(249 249 249);"> Total Transaksi Obat</th>
                                            <td>Rp. 877</td>
                                            <td>Rp. 511</td>
                                            <td>Rp. 178</td>
                                        </tr>
...
function onContentLoad() {
    ...
    methods : {
        ...
        printToPDF() {
            const content = this.$refs.cetakRiwayat;
            const options = {
