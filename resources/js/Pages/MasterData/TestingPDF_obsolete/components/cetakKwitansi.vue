        ...
        <div class="uk-container paper-like" style="padding:0 1em 10em;height: auto;" >
            <div style="position: sticky;top:10px;z-index:100;">
                <div class="uk-width-1-1 uk-text-right">
                    <input class="submit" type="submit" value="Print" style="margin-right:-120px" @click="printDiv('cetakanKiwtansi')">
                </div>
            </div>
            <ul style="padding:0;margin:0;" id="cetakanKiwtansi">
                    ...
                    <div style="padding:1em 0 1em 0;" class="uk-container">
                        <div style="padding:0; margin-top:1em; border-radius:10px;min-height:400px;" id="pdf-body-b">
                            ...
                            <div class="uk-align-center ">
                                <div>
                                    <p class="uk-margin-small" style="font-size:16px;font-weight:bold;text-align:center;font-family: verdana-bold;letter-spacing:1.1px;text-decoration: underline">KWITANSI</p>
                                    <p class="uk-margin-small" style="font-size:12px;font-weight:bold;text-align:center;">No. : PM2306727-000001</p>
                                </div>
                            </div>
                            <table style="width:100%;font-size:12px;">
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>THERESIA RENATA S</td>
                                </tr>
                                <tr>
                                    <td>Banyaknya uUang</td>
                                    <td>:</td>
                                    <td>Rp. 1,795,827,-</td>
                                </tr>
                                <tr>
                                    <td>Terbilang</td>
                                    <td>:</td>
                                    <td>Satu juta tujuh ratus sembilan puluh lima ribu depalan ratus dua puluh tujuh rupiah</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Biaya-biaya</td>
                                    <td>:</td>
                                    <td>Rawat Jalan, No. Invoice : PM2306727-000001 / No. Registrasi : REG/EM/2306726-0024</td>
                                </tr>
                                <tr>
                                    <td>Pasien a.n.</td>
                                    <td>:</td>
                                    <td>THEREISA RENATA S . Nn</td>
                                </tr>
                            </table>
                            
                            <hr style="border:1px solid #cc0202;" />
                            <table style="width:80%;margin-top:30px;font-size:12px;float:left;">
                                <tr>
                                    <td>No.</td>
                                    <td>Cara Bayar</td>
                            ...
                            <table style="width:20%;margin-top:30px;font-size:12px;text-align:center;">
                                <tr><td>Jakarta, 27 June 2023</td></tr>
                                <tr><td>Kasir, </td></tr>
