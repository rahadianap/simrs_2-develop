        ...
        <div class="uk-container paper-like" style="padding:0 1em 10em;height: 320mm;" >
            <div style="position: sticky;top:10px;z-index:100;">
                <div class="uk-width-1-1 uk-text-right">
                    <input class="submit" type="submit" value="Print" style="margin-right:-120px" @click="printDiv('cetakUangMukaPasien')">
                </div>
            </div>
            <ul style="padding:0;margin:0;" id="cetakUangMukaPasien">
                    ...
                    <div style="padding:1em 0 1em 0;" class="uk-container">
                        <div style="padding:0; margin-top:1em; border-radius:10px;min-height:400px;" id="pdf-body-b">
                            ...
                            <div class="uk-align-center uk-margin-medium">
                                <div>
                                    <p class="uk-margin-small" style="font-size:20px;font-weight:bold;text-align:center;font-family: verdana-bold;letter-spacing:1.1px;text-decoration: underline">UANG MUKA PASIEN RAWAT INAP</p>
                                </div>
                            </div>
                            <table style="width:100%;font-size:14px;letter-spacing:0.5px;" class="uk-margin-small">
                                <tr>
                                    ...
                                    <td style="font-family:cour">: {{ no_reg }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="font-family:cour;font-weight:bold;">Kelas / Ruang Rawat</td>
                                    <td style="font-family:cour">: {{ kelas }} / {{ ruang_perawatan }}</td>
                                    <td style="font-family:cour;font-weight:bold;">No.Tempat Tidur</td>
                                    <td style="font-family:cour">: {{ no_tempat_tidur }}</td>
                                </tr>
                                <tr>
                                    <td style="font-family:cour;font-weight:bold;">No. Identitas</td>
                                    <td style="font-family:cour">: </td>
                                </tr>
                                <tr>
                                    <td colspan="4"><hr></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="font-family:cour">: Diri sendiri</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-family:cour">: 0829301238102938 </td>
                                </tr>
                                <tr>
                                    <td style="font-family:cour;font-weight:bold;">No. Identitas</td>
                                    <td style="font-family:cour">: </td>
                                ...
                                <tr>
                                    ...
                                    <td style="font-family:cour">: Rp 8.864.000</td>
                                </tr>
                                <tr>
                                    <td style="font-family:cour;font-weight:bold;">- Pembayaran Sekarang</td>
                                    <td style="font-family:cour">: Rp 0</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-family:cour;font-weight:bold;">: Rabu / {{ tgl_masuk }}</td>
                                </tr>
                            </table>
                            <table style="width:100%;font-size:14px;letter-spacing:0.5px;padding-top:40px;" class="uk-margin-small">
                                <tr>
