                    ...
                    <table class="uk-table uk-table-striped hims-picker-table uk-table-responsive">
                        ...
                        <tbody>
                            <tr v-if="listItems && listItems.length > 0" v-for="item in listItems">
                                ...
                                <td><button @click.prevent="proceedFunction(item)"><span uk-icon="check"></span> pilih</button></td>
                            </tr>
                            <tr v-else>
                        ...
                        <tfoot>
                            <tr style="border-bottom:1px solid #cc0202;">
                                <td :colspan="fieldDatas.length + 1">
                                    <act-picker-pagination ref="pagination" 
                                        :pagination = pagination 
                                        v-on:pageChange="pageChange" 
                                        v-on:numRowsChange="rowChange">
                                    </act-picker-pagination>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
...
import ActPickerPagination from '@/Pages/MasterData/InformedConsent/components/ModalPickerPertanyaan/ActPickerPagination.vue';

export default {
    name : 'modal-picker-pertanyaan',
    props : {
    ...
    components : {
        TablePicker,ListPicker,ActPickerPagination
    },
    data() {
        return {
            params : {
