<template>
    <tr v-if="rowData" style="border-top:1px solid #eee;">
        ...
        <td style="width:130px;">
            <div style="margin:0;padding:0;">
                <a href="#" class="row-link-menu">
                    <p style="margin:0;padding:0;font-weight: 500;">{{rowData.rad_template_nama}}</p>
                    <p style="margin:0;padding:0;font-weight: 400;font-size: 11px;">{{rowData.rad_template_id}}</p>
                </a>
        ...
        <td>
            <p style="margin:0;padding:0;">{{rowData.uraian}}</p>
        </td>
        <td>
            <p style="margin:0;padding:0;">{{rowData.kesan}}</p>
        </td>
        <td>
