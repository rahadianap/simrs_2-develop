    ...
    <div style="padding:0;margin:0;background-color: whitesmoke;">
        <div class="uk-grid uk-grid-small" style="padding:0 0 0.5em 0;margin:0;background-color: !!transparent;">
            <p class="uk-width-expand@m" style="padding:0 0.2em 0.2em 0.2em;margin:0;font-style: italic; font-size:14px;">
                Referensi satuan dan kemasan persediaan    
            </p>
        </div>
        <div class="uk-card uk-card-default">
            <table class="uk-table uk-table-striped" style="padding:0;margin:0;">
                <thead>
                    <th style="padding:1em;margin:0;color:white;font-size:14px;font-weight:400;background-color:#cc0202;">SATUAN</th>
                ...
                <tbody>
                    <tr v-if="allowEdit">
                        ...
                        <td style="padding:0.5em;margin:0;color:black;font-size:12px;max-width:100px;">
                            <input class="uk-input uk-form-small uk-text-uppercase" type="text" v-model="refData.text" required>
                        </td>
                    ...
                    <tr v-for="dt in listData.json_data">
                        <td style="padding:1em;margin:0;color:black;font-size:12px;font-weight:500;width:100px;">{{dt.value}}</td>
    ...
    methods : {
        ...
        addData(){
            if(this.refData.value == null || this.refData.value == '' || this.refData.text == ''|| this.refData.text == null){
                ...
                this.refData.text = this.refData.text.toUpperCase(); 
