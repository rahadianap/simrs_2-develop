<template>
    <div class="uk-container uk-container" style="padding:1em;">
        <header-page title="MASTER REFERENSI PRODUK" subTitle="master data referensi produk dan persediaan"></header-page>
        <div style="margin-top:1em;">
            <div class="uk-card" style="padding:0;margin:0;border-radius:10px;min-height:400px;">
                <ul uk-tab style="padding:0;">
                    ...
                    <li><a href="#" style="font-size:14px;font-weight:500;">CARA PAKAI OBAT</a></li>
                    <li><a href="#" style="font-size:14px;font-weight:500;">UNIT SATUAN</a></li>
                    <li><a href="#" style="font-size:14px;font-weight:500;">SEDIAAN</a></li>
...
import FormGolongan from '@/Pages/MasterData/GolonganProduk/Components/FormGolongan.vue';
import FormKlasifikasi from '@/Pages/MasterData/GolonganProduk/Components/FormKlasifikasi.vue';
import FormLabelObat from '@/Pages/MasterData/GolonganProduk/Components/FormLabelObat.vue';
import FormSatuan from '@/Pages/MasterData/GolonganProduk/Components/FormSatuan.vue';
import FormSediaan from '@/Pages/MasterData/GolonganProduk/Components/FormSediaan.vue';
