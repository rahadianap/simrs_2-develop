<template>
    <tr v-if="rowData" style="border-top:1px solid #eee;">
        ...
        <td style="width:130px;">
            <div style="margin:0;padding:0;">
                <a href="#" class="row-link-menu">
                    <p style="margin:0;padding:0;font-weight: 500;">{{rowData.pa_template_nama}}</p>
                    <p style="margin:0;padding:0;font-weight: 400;font-size: 11px;">{{rowData.pa_template_id}}</p>
                </a>
        ...
        <td>
            <p style="margin:0;padding:0;">{{rowData.hasil}}</p>
        </td>
        <td>
...
export default {
    ...
    name : 'row-list-patologi-template',
    data() {
        return {
            isExpanded : false,
            selectAll : true,
