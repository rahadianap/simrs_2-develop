    ...
    <div class="uk-container" style="padding:1em;">
        <div class="uk-grid uk-grid-small">
            <div class="uk-width-auto">
                <a href="#" @click.prevent="returnMainPage" style="background-color:white;padding:0.3em;display:inline-block;">
            ...
            <div class="uk-width-expand">
                ...
                <p style="font-weight:300;margin:0;padding:0;font-size:12px;font-style:italic;">
                    ubah dan buat master data unit kerja dan pelayanan
                </p>
            </div>
        </div>
        
        <div class="uk-container-large" style="margin-top:1em;background-color:#fff;min-height:80vh; ">
            <!-- <form-unit-pelayanan ref="formUnitPelayanan"></form-unit-pelayanan>  -->
...
import FormUnitPelayanan from '@/Pages/MasterData/UnitPelayanan/components/FormUnitPelayanan.vue';
...
export default {
    ...
    methods: {
        ...
        initialize() {
            ...
            if(this.unitId == '' || this.unitId == 'baru' || this.unitId == null) {
                //this.$refs.formUnitPelayanan.newUnitPelayanan();
                this.newUnitPelayanan();
            }
            else {
                //this.$refs.formUnitPelayanan.editUnitPelayanan(this.unitId);
                this.editUnitPelayanan(this.unitId);
            }
