    ...
    <div>
        ...
        <table class="uk-table uk-table-striped">
            <thead>
                ...
                <th style="padding:0.2em;margin:0;color:black;font-size:14px;font-weight:500;">IS_BPJS</th>
            ...
            <tbody>
                    ...
                    <td  style="padding:1em 0.5em 0.5em 0.5em;margin:0;color:black;font-size:12px;">
                        <div class="uk-form-controls">
                            <label style="color:black; font-size:14px;">
                                <input class="uk-checkbox" type="checkbox" v-model="refData.is_bpjs"> BPJS
                            </label>
                        </div>
                    </td>
                ...
                <tr v-for="dt in listData.json_data">
                    ...
                    <td style="padding:0.5em;margin:0;color:black;font-size:12px;">
                        <input class="uk-checkbox" type="checkbox" v-model="dt.is_bpjs" disabled>
                    </td>                    
