                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid >
                            ...
                            <div class="uk-width-3-4@s uk-grid-small" uk-grid> 
                                ...
                                <template v-if="isRefProdukExist" v-for="gol in golonganProdukRefs.json_data">
                                    <div  v-if="gol.jenis_produk=='UMUM' && gol.aktif" class="uk-width-1-3@m" style="margin:0;padding:0.2em 0.2em 0.2em 1.2em;">
                                        <div class="uk-form-controls">
                                ...
                                <template v-if="isRefProdukExist" v-for="klas in klasifikasiProdukRefs.json_data">
                                    <div  v-if="klas.jenis_produk=='UMUM' && klas.aktif" class="uk-width-1-3@m" style="margin:0;padding:0.2em 0.2em 0.2em 1.2em;">
                                        <div class="uk-form-controls">
                                            <label style="color:black; font-size:12px;">
...
export default {
    ...
    methods : {
        ...
        checkProdukId(){
            ...
            this.listVendor({per_page:'ALL'});
            this.listProdukAkun({per_page:'ALL'});
            if(this.isProductAccountExist) { 
                this.produkAccount = this.productAccounts.filter(item => {return item['jenis_produk'].toUpperCase()== 'UMUM'});
            }
            this.listRefProduk({per_page:'ALL'});
