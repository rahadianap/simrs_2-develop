                ...
                <ul class="uk-breadcrumb" style="padding:0;margin:0;">
                    <li>
                        <a href="#" @click.prevent="closeModalItem" class="uk-text-uppercase">
                            <h4 style="font-weight:500;margin:0;padding:0;display: inline-block;" class="uk-text-uppercase">MASTER ITEM MEDIS </h4>
                        </a> 
                    </li>
                ...
                <form action="" @submit.prevent="submitItemMedis" >
                    <div class="uk-grid-small uk-card uk-card-default hims-form-header uk-box-shadow-large" uk-grid >
                        <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                            <h5 class="uk-text-uppercase">DATA ITEM MEDIS</h5>
                        </div>                                
                            ...
                            <div class="uk-width-3-4@s uk-grid-small" uk-grid>                                 
                                <div class="uk-width-2-3@m">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input uk-form-small uk-text-uppercase" :disabled="isUpdate" v-model="produk.produk_nama" type="text" placeholder="nama item medis" required>
                                    </div>
                                </div>
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid >
                            ...
                            <div class="uk-width-3-4@s uk-grid-small" uk-grid> 
                                ...
                                <div class="uk-width-1-3@m" style="margin:0;padding:0.2em 0.2em 0.2em 1em;">
                                    <div class="uk-form-controls">
                                        <label style="color:black; font-size:14px;">
                                            <input class="uk-checkbox" type="checkbox" value="1" v-model="produk.is_sterilisasi"> Sterilisasi
                                        </label>
                                    </div>
                                    <p style="font-size:11px; color:black;font-style:italic;padding:0.2em 0.2em 0.2em 2em;margin:0;">item butuh proses sterilisasi.</p>
                                </div>
                                <div class="uk-width-1-3@m" style="margin:0;padding:0.2em 0.2em 0.2em 1em;">
                                    <div class="uk-form-controls">
                                        <label style="color:black; font-size:14px;">
                                            <input class="uk-checkbox" type="checkbox" value="1" v-model="produk.is_laundry_item"> Cuci / Laundry
                                        </label>
                                    </div>
                                    <p style="font-size:11px; color:black;font-style:italic;padding:0.2em 0.2em 0.2em 2em;margin:0;">item perlu proses pencucian.</p>
                                </div>
                            </div>
                        </div>
                        <div class="uk-grid-small hims-form-subpage" uk-grid >
                        ...
                        <div class="uk-grid-small hims-form-subpage" uk-grid >
                            ...
                            <div class="uk-width-3-4@s uk-grid-small" uk-grid> 
                                ...
                                <template v-if="isRefProdukExist" v-for="gol in golonganProdukRefs.json_data">
                                    <div  v-if="gol.jenis_produk=='MEDIS' && gol.aktif" class="uk-width-1-3@m" style="margin:0;padding:0.2em 0.2em 0.2em 1.2em;">
                                        <div class="uk-form-controls">
                                ...
                                <template v-if="isRefProdukExist" v-for="klas in klasifikasiProdukRefs.json_data">
                                    <div  v-if="klas.jenis_produk=='MEDIS' && klas.aktif" class="uk-width-1-3@m" style="margin:0;padding:0.2em 0.2em 0.2em 1.2em;">
                                        <div class="uk-form-controls">
                                            <label style="color:black; font-size:12px;">
                                                <input class="uk-checkbox" type="checkbox" :value="klas" v-model="klasifikasi"> 
                                                    {{klas.value}}<p style="font-size:11px; color:black;font-style:italic;padding:0.2em 0.2em 0.2em 2em;margin:0;">({{klas.desc}})</p>
                                            </label>
                                        </div>                                        
                                    </div>
                                </template>
