<template>
    <div class="uk-modal uk-modal-container" uk-modal="bg-close:true;" :id="modalId" style="min-height:50vh;">
        <div class="uk-modal-dialog uk-modal-body">
            <h2 class="uk-modal-title">RESEP & OBAT</h2>
            <div style="padding:0;margin:0;">
                <form action="" @submit.prevent="submitResep">
                        ...
                        <div class="uk-width-1-1@s uk-grid-small" uk-grid style="padding:0 0.5em 0 0.5em;">
                            <div class="uk-width-expand@m">
                                <h5 style="color:indigo;padding:0;margin:0;">DATA PASIEN
                                    <span style="font-size:12px;font-style:italic;padding:0;margin:0;"> catatan data pasien.</span>
                                </h5>
                            </div>
                        </div>
                        <div class="uk-width-3-4@s uk-grid-small" uk-grid> 
                            <div class="uk-width-1-2@m">
                                <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">No. Pendaftaran</label>
                                <div class="uk-form-controls">
                                    <search-select  ref="searchSigna"
                                        :config = configSelect
                                        searchUrl = '/outpatient/transactions'
                                        placeholder = "pilih nomor pendaftaran"
                                        captionField = "reg_id"
                                        valueField = "reg_id"
                                        :itemListData = trxDesc
                                        :value = "pasien.reg_id"
                                        v-on:item-select = "trxSelected"
                                    ></search-select>
                                </div>
                            </div>
                            <div class="uk-width-1-2@m">
                                ...
                                <div class="uk-form-controls">
                                    <input type="text" v-model="pasien.nama_pasien" class="uk-input uk-form-small" readonly>
                                </div>
                            </div>
                            <div class="uk-width-1-2@m">
                                <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">No. RM</label>
                                <div class="uk-form-controls">
                                    <input type="text" v-model="pasien.no_rm" class="uk-input uk-form-small" readonly>
                                </div>
                            </div>
                            <div class="uk-width-1-2@m">
                                <label class="uk-form-label" style="padding:0;margin:0;font-size:12px;">Nama Dokter</label>
                                <div class="uk-form-controls">
                                    <input type="text" v-model="pasien.nama_dokter" class="uk-input uk-form-small" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="uk-grid-small hims-form-subpage" uk-grid >
                        <div class="uk-width-1-1@s uk-grid-small" uk-grid style="padding:0 0.5em 0 0.5em;">
                            <div class="uk-width-expand@m">
                                <h5 style="color:indigo;padding:0;margin:0;">RESEP & OBAT
                        ...
                        <div v-else class="uk-width-1-1@s uk-grid-small" uk-grid>
                            <div class="uk-width-1-1@m">
                                <div style="padding:0 0 0.2em 0;">
                                    <table class="uk-table uk-table-striped" style="padding:0;margin:0;">
                                        <thead>
                                            <th class="tb-header-reg" style="text-align:center;color:white;background-color: #cc0202;">Racik2</th>
...
export default {
    name : 'form-resep',
    props : { 
        modalId : { type:String, required:false, default:'formResep' }, 
    },
    components : {
        SearchSelect
    },
    data() {
        return {
            ...
            trxDesc : [
                { colName : 'reg_id', labelData : '', isTitle : true },
    ...
    methods : {
        ...
        trxSelected(data) {
            console.log(data);
            if(data) {
                this.pasien.reg_id = data.reg_id;
                this.pasien.nama_pasien = data.nama_pasien;
                this.pasien.no_rm = data.no_rm;
                this.pasien.nama_dokter = data.dokter_nama;
                this.prescription.reg_id = data.reg_id;
                this.prescription.trx_id = data.trx_id;
                this.prescription.reff_trx_id = data.reff_trx_id;
                this.prescription.peresep = data.dokter_nama;
            }
        },
