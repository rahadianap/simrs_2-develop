<template>
    <tr style="border-bottom:1px solid #ccc;">
        ...
        <td style="width:60px;padding:0.4em; font-size: 12px; text-align:center; color:black;">
            <input v-model="itemResep.jml_ambil" class="uk-input uk-form-small" type="number" style="text-align: center;" @change="rowDataChange">
        </td>
    ...
    methods : {
        ...
        addItemResep(data){
            if(data) {
                ...
                // if(this.fnAddCallback) { this.fnAddCallback(data); }
                if(data.item_tipe == 'HEADER_RACIKAN') {
                    if(data.signa_deskripsi == "" ||  data.signa_deskripsi == null) {
                        alert('cara pakai harus di isi');
                        return false;
        ...
        rowDataChange(){
            this.itemResep.subtotal = (this.itemResep.jml_ambil * (this.itemResep.nilai - this.itemResep.diskon)) * 1;
        },
