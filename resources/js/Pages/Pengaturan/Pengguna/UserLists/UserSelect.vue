...
<template>
    <div :class="config.compClass" ref="containerSearchSelect" :style="config.compStyle" class="myUserSelectContainer">
  	    ...
  	    'value': function(newVal, oldVal) {
            if(newVal == '' || newVal == null) {
                ...
                if(this.focused == false) { 
                    if(this.config.retrieveAll == true) { 
                        this.listData();  
                    }
                    else { 
                        this.listSearchData(); 
