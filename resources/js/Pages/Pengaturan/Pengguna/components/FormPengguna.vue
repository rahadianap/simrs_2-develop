                ...
                <ul class="uk-breadcrumb" style="padding:0;margin:0;">
                    <li>
                        <a href="#" @click.prevent="closeModal" class="uk-text-uppercase">
                            <h4 style="font-weight:500;margin:0;padding:0;display: inline-block;" class="uk-text-uppercase">DATA PENGGUNA</h4>
                        </a> 
                    </li>
                </ul>
            </div>
            ...
            <form action="" @submit.prevent="submitPengguna">
                <div class="uk-grid-small uk-card uk-card-default hims-form-header" uk-grid>
                    <div class="uk-width-expand" style="padding:1em 0.5em 0.1em 1em;margin:0;">
                        <h5 class="uk-text-uppercase">DATA PENGGUNA</h5>
                    </div>                                
                    ...
                    <div class="uk-grid-small hims-form-subpage" uk-grid >
                        ...
                        <div class="uk-width-3-4@m uk-grid-small" uk-grid>
                            ...
                            <div class="uk-width-1-1@m" style="margin:0;padding:1em 0.2em 0.2em 1em;">
                                ...
                                <p style="font-size:11px; color:black; padding:0.2em 0.2em 0.2em 2em;margin:0;">pengguna aktif dan boleh mengakses aplikasi.</p>
                            </div>
                        </div>
                    </div>
                    <div class="uk-width-1-1">
                        <ul uk-tab style="padding:0;margin:0;" class="uk-width-1-1">
                            <li><a href="#" style="font-size:14px;font-weight:500;"><h5 style="padding:0;margin:0;">UNIT PENGGUNA</h5></a></li>
                            <li v-if="isUpdate"><a href="#" style="font-size:14px;font-weight:500;"><h5 style="padding:0;margin:0;">DEPO PENGGUNA</h5></a></li>
                        </ul>
                        <ul class="uk-switcher" style="padding:0;margin:0;">
                            <li>
                                <div class="uk-width-1-1@m uk-grid-small" uk-grid style="margin-top:1em;padding-left:2em;">   
