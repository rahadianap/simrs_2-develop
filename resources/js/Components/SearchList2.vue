    ...
    <div :class="config.compClass" ref="containerListSelect" :style="config.compStyle" class="myListSelectContainer">
        ...
        <div class="uk-form-controls list-select-input">
            <div class="uk-inline uk-width-1-1">
                <input ref="inputListSelect" class="uk-input uk-form-small" type="text" style="color:black;"
...
export default {
    ...
    methods : {
        ...
        selectItem(val,index) {      
            ...
            this.searchKeyword = val[this.captionField];
            this.hideDropList();
        },
        ...
        listData(init) { 
            ...
            this.items = this.dataLists.filter(item => {
                return item[this.captionField].toLowerCase().includes(this.searchKeyword.toLowerCase())
            });
            if(this.items.length == 0) {
                this.selectedData = null;
                this.listindex = -1;
