    ...
    methods : {
        valueChange(newVal){
            ...
            if(newVal == '' || newVal == null) {
                ...
                //     return (item[this.valueField].toLowerCase() == newVal.toLowerCase() || item[this.captionField].toLowerCase() == newVal.toLowerCase());
                // }) 
        ...
        listData(init) { 
            ...
            if(init) {
                if(this.value == null || this.value == '') {
                    ...
                    // this.listindex = -1;
                    // this.items = this.listData.filter(item => {return item[this.valueField].toUpperCase().includes(this.value.toLowerCase())});
