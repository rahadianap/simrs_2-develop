<template>
    ...
    <div class="hims-table-pagination uk-grid-small" uk-grid style="padding:0;margin:0;">
        
        <div  v-if="pagination.total_data > pagination.per_page || pagination.total_data > 10 " 
            class="uk-width-expand@m uk-align-center@l" style="margin:0 auto;padding:0.5em;">
            ...
            <span v-if="mode == 'SIMPLE'" style="padding:0 0.5em 0 0.5em;">
            ...
            <span v-else>
                <a v-for="num in pages" v-bind:class="{ 'active': num == pagination.current_page, 'uk-visible@m' :true }" href="#" @click.prevent="setActiveIndex(num)">{{num}}</a>            
            </span>
        ...
        <div v-else class="uk-width-expand@m uk-align-center@l" style="margin:0 auto;padding:0.5em;"></div>
