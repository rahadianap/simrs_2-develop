<template>
    <div class="app-layout" style="width:100%;margin:0;padding:0;">        
        <navbar>
        ...
        <div id="content-container" class="tm-main uk-section uk-section-default uk-grid uk-grid-small" uk-grid >            
            <div class="uk-width-auto uk-visible@m" style="margin:0;padding:0;">
                <sidenav  v-if="isReady" :ubahPassword="changePassword"/>
            </div>
            <div id="div-content" class="uk-width-expand uk-container uk-container-xlarge">
                <slot/>
            </div>
        </div>
