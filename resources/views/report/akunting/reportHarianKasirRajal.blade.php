...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>LAPORAN HARIAN KASIR RAWAT JALAN</title>
        <!-- styling -->
    ...
    <body>
        ...
        <div class="uk-align-center" style="padding:0px !important;background-color:red;">
            <div style="font-size:14px;font-weight:bold;text-align:center;padding:0px !important;">LAPORAN HARIAN KASIR RAWAT JALAN</div>
        </div>
        <!-- Data Kasir -->
