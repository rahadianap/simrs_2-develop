...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="uk-align-center uk-margin-remove">
            <div>
                <p class="uk-margin-remove" style="font-size:14px;font-weight:bold;text-align:center;text-decoration-line: underline;">BUKTI PENDAFTARAN RAWAT JALAN</p>
            </div>
        </div>
        {{-- ISI --}}
        <div class="uk-grid-small uk-align-center" uk-grid>
            <table style="margin-left:auto;margin-right:auto;width:65%;">
                <tr>
                    <td style="font-weight:bold;">{{ $data['pendaftaran']['unit_nama'] }}</td>
                </tr>
                <tr>
