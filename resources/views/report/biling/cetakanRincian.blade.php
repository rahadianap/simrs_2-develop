...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="uk-align-center" style="padding:0px !important;background-color:red;">
            <div style="font-size:14px;font-weight:bold;text-align:center;padding:0px !important;">RINCIAN TAGIHAN PASIEN</div>
        ...
        <table class="uk-table uk-table-small no-border-table" style="margin-top:-15px;margin:auto;width:60%;font-size:10px !important;">
            ...
            <tr>
                ...
                <td>Pelunasan</td>
                <td>: </td>
                <td style="text-align:right !important;">{{ number_format(($data['grand_total'] - $data['sisa_tagihan']), 2) }}</td>
            </tr>
            <tr>
                {{-- Kiri --}}
                <td>Diskon</td>
            ...
            <tr>
                ...
                <td>Sisa Tagihan</td>
                <td>: </td>
                <td style="text-align:right !important;border-top:1px dotted black;">{{ number_format($data['sisa_tagihan'], 2) }}</td>
            </tr>
            <tr>
                {{-- Kiri --}}
                <td></td>
