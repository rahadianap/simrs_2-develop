...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>FORM LAPORAN HASIL PEMERIKSAAN LABORATORIUM</title>
        <!-- styling -->
    ...
    <body>
        ...
        <div class="uk-align-center uk-margin-remove">
            <div>
                <p class="uk-margin-remove" style="font-size:20px;font-weight:bold;text-align:center;text-decoration-line:underline;">FORM LAPORAN HASIL PEMERIKSAAN LABORATORIUM</p>
            </div>
        </div>
        {{-- ISI --}}
