...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="uk-align-center uk-margin-remove">
            <div>
                <p class="uk-margin-remove" style="font-size:14px;font-weight:bold;text-align:center;text-decoration-line: underline;">LAPORAN PEMERIKSAAN PASIEN LABORATORIUM</p>
        ...
        <table class="uk-table uk-table-small standard-table" style="margin-top:-15px;margin:auto;width:100%;font-size:9px !important;">
            ...
            @foreach ($data['detail'] as $index => $detail)
                <tr>
                    ...
                    <td style="padding-left:5px;">{{ $detail['item_nama'] }}</td>
                    <td style="padding-left:5px;text-align:right;">{{ number_format($detail['subtotal'], 2) }}</td>
